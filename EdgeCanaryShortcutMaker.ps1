...
$FullVersionToUse = "143.0.3620.0"

$Arguments = "--enable-features=MscopilotSettings,msEdgePinpointJustInTimeDocAI,msEdgePinpointJustInTimeEduAI,msEdgePinpointJustInTimeEmailAI,msSendToCopilotInContextMenu,msuYE1"
