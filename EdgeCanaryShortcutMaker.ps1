...
$FullVersionToUse = "142.0.3576.0"

$Arguments = "--enable-features=msCopilotUserInfoPolling,msM365LinkAutoOpenIgnoreSidebarStateEnabled,msNDFREConsumerOnPinSitesScreenTrigger,msNewDefaultSiteSuggestionV2,msVisualRejuvMicaTrigger"
