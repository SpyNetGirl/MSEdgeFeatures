...
$FullVersionToUse = "147.0.3869.0"

$Arguments = "--enable-features=Ms1PNetworkRequestTelem,MsSntpSwr,msEdgeGameAssistEnableFindOnPage,msFontFamilyTokenization,msNurturingBannerSurfaceShownTrigger,msShoppingUapiExp35Success"
