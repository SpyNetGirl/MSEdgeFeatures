...
$FullVersionToUse = "148.0.3942.0"

$Arguments = "--enable-features=msEdgeCloudPolicyApplySourceV2,msEdgeCloudPolicyV1,msEdgeCopilotNtpDailyRefreshBackgroundAAD,msNurturingFrequentSitesPinUpsell"
