...
$FullVersionToUse = "146.0.3825.0"

$Arguments = "--enable-features=msSegmentationPlatformUrlInterestsJustInTimeInterviewPrep,msSegmentationPlatformUrlInterestsJustInTimeJobApplication,msStartupMitigatedTrigger"
