...
$FullVersionToUse = "145.0.3732.0"

$Arguments = "--enable-features=MSCpE1,mSTAE1,msEdgeComposerShowLocalActionsMode,msEdgeSunflowerRetryNavigationOnFailure,msEdgeSunflowerTryPasswordsFirst"
