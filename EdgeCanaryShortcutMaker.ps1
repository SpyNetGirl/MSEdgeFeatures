...
$FullVersionToUse = "146.0.3841.0"

$Arguments = "--enable-features=msAllowToolsCreation,msEdgeEnableCloudContentScanning,msEdgeReadingModeSDExtraction,msIncludeExtensionTabActivityInFeedback,msNoPinningCooldownApplied,msNurturingFrequentSitesPinUpsellCustomTriggerAfterBasicTargetingCheck,msPrimaryScreenResolution1600X900"
