...
$FullVersionToUse = "142.0.3579.0"

$Arguments = "--enable-features=msEdgeOmniboxNavigateToCopilotSearch,msEdgeToolsDebugger,msEdgeTrv2Policy,msEnableCIFromAnaheim,msNonPrerenderNtpOrPostFreDhpNavigation,msUpdateReadingModeDlpContext"
