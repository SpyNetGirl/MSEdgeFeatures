...
$FullVersionToUse = "141.0.3510.0"

$Arguments = "--enable-features=msArbitrationServiceLoggerUI,msAskCopilotPageSubmenuNoCitation,msDisableOmniboxCashback,msEdgeShoppingDisableForAADUsers,msEdgeUpstreamDownloadAccountStateForTest,msEnableOverflowIconAnimationParam"
