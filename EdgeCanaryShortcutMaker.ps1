...
$FullVersionToUse = "141.0.3497.0"

$Arguments = "--enable-features=msAskCopilotPageSubmenuExplain,msOmniboxEnableDirectNavAllRegions,msPageInteractionRestrictionWindowsRecallSupport,msPdfFormsLoadAnnotsArray,msRichUnifiedComposer,msWindowsRecallDlpSupport,msterdam"
