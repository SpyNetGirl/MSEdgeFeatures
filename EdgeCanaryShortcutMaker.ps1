...
$FullVersionToUse = "152.0.4167.0"

$Arguments = "--enable-features=msEdgeBrowserHasslesExtensionDnrShowUx,msEdgeBrowserHasslesExtensionDnrSignal,msEdgeBrowserHasslesExtensionDnrTrigger,msEdgeBrowserHasslesExtensionDnrTriggerHubAA,msEdgeSplitWindowConvergeToolbarButton,msExtensionDnrPreconditionMetTrigger,msExtensionDnrStrategyFiredTrigger,msPhoenixEdgeFrameConnTabsColor"
