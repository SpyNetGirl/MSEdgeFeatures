...
$FullVersionToUse = "145.0.3757.0"

$Arguments = "--enable-features=msEdgeCMMoreMenuOpenedFirstTime,msEdgeCMMoreMenuOpenedFirstTimeNPB,msEdgeCMMoreMenuOpenedFirstTimePB"
