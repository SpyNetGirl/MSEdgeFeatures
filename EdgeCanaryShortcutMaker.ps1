...
$FullVersionToUse = "147.0.3909.0"

$Arguments = "--enable-features=msCustomizeEdgeShown,msDetectDefaultBrowserChanged,msEdgeAutofillSupportDropdownFillingForOperator,msEdgeNelObserver,msPerformActionAutolaunch,msPerformActionPinToTaskbar"
