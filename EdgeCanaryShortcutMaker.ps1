...
$FullVersionToUse = "145.0.3740.0"

$Arguments = "--enable-features=msAssetStoreContinueOnShutdown,msEdgeCopilotModeMoreMenuToggle,msEdgePreconnectCMC,msEnableDataControls,msIncludeLocalAgentDataInFeedback,msIncludeSecureNetworkDataInFeedback,msIncludeSegmentationPlatformInfoInFeedback,msIncludeTrackingPreventionDataInFeedback,msNurturingFeatureEdgeSpawnNtpOptIn,msNurturingUndefinedFeaure"
