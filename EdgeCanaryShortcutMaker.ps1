...
$FullVersionToUse = "145.0.3770.0"

$Arguments = "--enable-features=msCoFreeTimerInMinutes,msEdgeBrowserHasslesTriggeringFramework,msEnableCoFreeTimer,msTechscamNewBlockPage"
