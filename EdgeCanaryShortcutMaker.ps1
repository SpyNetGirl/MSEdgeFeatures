...
$FullVersionToUse = "151.0.4098.0"

$Arguments = "--enable-features=msEdgeLimitAutoOpenCopilotToSignedInUsers,msEdgeSettingsDefaultBrowserNotDefault,msEdgeSettingsDefaultBrowserPage"
