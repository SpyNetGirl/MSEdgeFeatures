...
$FullVersionToUse = "149.0.3996.0"

$Arguments = "--enable-features=msCopilotNtpMoreMenuOpenedFirstTime,msCopilotNtpMoreMenuOpenedFirstTimeEdgePB,msCopilotNtpMoreMenuOpenedFirstTimeNonEdgePB,msCopilotNtpMoreMenuToggle,msCopilotNtpMoreMenuTriggers,msDesktopModePin,msEdgePostScoobeExpSignal,msEdgePostScoobeFwlinkId,msEdgePostScoobeMarketingPageVisited,msStudioNtpFocusDropdown"
