...
$FullVersionToUse = "153.0.4219.0"

$Arguments = "--enable-features=msEdgeProtectPinnedTabs,msEdgeToolsBridgeDispatchTimeoutSeconds,msEdgeToolsResponseCollectionTimeoutSeconds,msEdgeToolsToolExecutionTimeoutSeconds"
