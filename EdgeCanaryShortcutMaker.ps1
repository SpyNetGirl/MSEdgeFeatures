...
$FullVersionToUse = "141.0.3530.0"

$Arguments = "--enable-features=msConsumerCopilotLabelButton,msFontDataServiceInboxedFontSupport,msPdfCreatePodcastCopilotAction"
