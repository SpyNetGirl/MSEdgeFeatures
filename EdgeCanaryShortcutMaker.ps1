...
$FullVersionToUse = "148.0.3940.0"

$Arguments = "--enable-features=msDlpSensitiveContentHandling,msEdgeReaderModeV2ViewerInitialized,msEdgeStudioNTPPersonalizedCards,msNurturingMSStartYJCompeteTextVolumn,msOmniboxSearchHistoryRecentIcon,msSettingsLazyLoadAutofillSubApps,msStaleTileEligibleTrigger"
