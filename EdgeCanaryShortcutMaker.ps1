...
$FullVersionToUse = "153.0.4226.0"

$Arguments = "--enable-features=msEdgeBrowserHasslesExtensionWebRequestShowUx,msEdgeBrowserHasslesExtensionWebRequestSignal,msEdgeBrowserHasslesExtensionWebRequestTrigger,msEdgeBrowserHasslesExtensionWebRequestTriggerHubAA"
