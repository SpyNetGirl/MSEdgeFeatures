...
$FullVersionToUse = "147.0.3906.0"

$Arguments = "--enable-features=MsARE1,msEdgeToolsScrollIntoView,msSegmentationPlatformFetchPersonalization,msShortcutsProviderSearchRelevanceTuning,msSwapUnloadedNtpWithPrerender,msWChromiumPromoteChat"
