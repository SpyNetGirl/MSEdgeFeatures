...
$FullVersionToUse = "153.0.4210.0"

$Arguments = "--enable-features=msEdgePdfViewerBtr,msEdgePdfViewerBtrDevServerBridge,msEdgeReaderModeLocationIconChip,msEdgeToolsCoworkShowTabBanner,msOnDeviceModelGpuProgramCache"
