...
$FullVersionToUse = "153.0.4196.0"

$Arguments = "--enable-features=msEdgeAutofillEnhancedAutofillFieldClickedTrigger,msEdgeAutofillEnhancedAutofillFormEligibleTrigger,msWhatsNewUpdatePageClientVisible"
