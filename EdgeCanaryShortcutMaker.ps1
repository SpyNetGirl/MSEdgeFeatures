...
$FullVersionToUse = "151.0.4083.0"

$Arguments = "--enable-features=msEnableMaiDesignSystemForMica,msEntertainmentSpotifyClientDetected,msEntertainmentSpotifyDetected,msEntertainmentSpotifyWebDetected"
