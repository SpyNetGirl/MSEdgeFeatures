...
$FullVersionToUse = "146.0.3810.0"

$Arguments = "--enable-features=msEdgeMoreToolsMenuOpenedTrigger,msEdgeNtpVNextFeedIntegrationCommercial,msPasswordBreachInContextAlertOkOnly,msPasswordBreachInContextAlertWithChangePassword,msPasswordBreachInContextAlertWithChangePasswordExtended,msSegmentationPlatformUrlInterestsCopilotModeUpsellOnNtp"
