...
$FullVersionToUse = "144.0.3675.0"

$Arguments = "--enable-features=msEdgeToolsCommercialScreenshotEncoding,msEdgeToolsCommercialScreenshotHeight,msEdgeToolsCommercialScreenshotWidth,msOmniboxLocalEntitiesShowResult,msTyposquattingAllowListUI"
