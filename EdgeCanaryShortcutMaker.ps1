...
$FullVersionToUse = "150.0.4055.0"

$Arguments = "--enable-features=MSvu6H,msAutoOpenInternalsBtr,msIEReactivationBtr,msShowBrowserCustomizationHubEntryPointForRubyNtp,msWUE1,msWcfTasksPolicyManagerKillSwitch,msgCompressError"
