...
$FullVersionToUse = "146.0.3817.0"

$Arguments = "--enable-features=msEnableWChromiumConfig,msWChromiumAutocompleteEnabled,msWChromiumMaxMatches,msWChromiumMaxUrlMatches"
