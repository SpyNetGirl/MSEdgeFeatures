...
$FullVersionToUse = "149.0.4003.0"

$Arguments = "--enable-features=msCopilotOpeningEndDelaySec,msCopilotOpeningSafetyTimeoutSec,msDetectDefaultBrowserChangedBadgeTrigger,msSearchHistoryAggressiveScoringDuration,msSearchHistoryRelevanceTuning"
