...
$FullVersionToUse = "149.0.3984.0"

$Arguments = "--enable-features=msEdgeMediaControlsOnMediaProxy,msEdgeMediaControlsOnMediaProxyAutoSplit,msEdgeMediaControlsOnMediaProxyPinnedSite,msPdfOcrMicrofeedback,msPushServiceBlockShutdown,msWebView2SyncClipboardRead"
