...
$FullVersionToUse = "145.0.3746.0"

$Arguments = "--enable-features=msStudioNtpEnableContentMarketOverride,msStudioNtpForceCookieBanner,msWhatsNewPageReminderCheckIsEdgePinnedToTaskbar"
