...
$FullVersionToUse = "155.0.4269.0"

$Arguments = "--enable-features=msFeatureMmxUpsellFavoriteSave,msFeatureMmxUpsellOwnPasswordSave,msFeatureMmxUpsellSuggestedStrongPasswordSave,msNurturingGroupMobileGrowthFavoriteSave,msNurturingGroupMobileGrowthPasswordSave"
