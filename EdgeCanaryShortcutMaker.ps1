...
$FullVersionToUse = "148.0.3943.0"

$Arguments = "--enable-features=msCopilotPerTab,msEdgeImportPreventDisallowedExtensionsInstall,msEdgeReaderModeReadAloudClicked,msUndersideV2ComponentExtension"
