...
$FullVersionToUse = "146.0.3834.0"

$Arguments = "--enable-features=msNurturingMaiThemeMigrationNotificationFlyout,msNurturingTimedTriggerForMobile,msOmniboxDesktopClipboardProviderSuppress"
