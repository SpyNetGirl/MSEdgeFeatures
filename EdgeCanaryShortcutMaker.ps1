...
$FullVersionToUse = "154.0.4239.0"

$Arguments = "--enable-features=msDisableAccountChangeForOSVersion,msEdgeAutomatedPasswordChange,msWebView2TraceHostAttribution"
