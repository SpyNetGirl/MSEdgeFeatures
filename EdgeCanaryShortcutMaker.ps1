...
$FullVersionToUse = "150.0.4072.0"

$Arguments = "--enable-features=msInstallPlatformExperiencesHelper,msPehNotificationEligibleTrigger,msShouldUseSpecificPehNotificationText,msShowPehNotifications"
