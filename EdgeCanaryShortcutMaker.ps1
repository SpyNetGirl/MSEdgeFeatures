...
$FullVersionToUse = "150.0.4045.0"

$Arguments = "--enable-features=msSSOBrowserHint,msSpaceworkHostMatchRelevance,msSpaceworkMaxMatches,msSpaceworkMinInputLength,msSpaceworkPathMatchRelevance,msSpaceworkSpecMatchRelevance,msStaleTileReplaceCISuggestionsTrigger"
