...
$FullVersionToUse = "142.0.3582.0"

$Arguments = "--enable-features=msEdgeBrowserCustomization,msEdgeFeedbackAllowDiagnosticData,msNurturingThemesMigrationBanner,msPdfScrollingOnMainThread"
