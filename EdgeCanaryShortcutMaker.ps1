...
$FullVersionToUse = "152.0.4185.0"

$Arguments = "--enable-features=msEdgeGraphMicrosoftGenuineEdgeTokenProtocolVersion,msEdgeLoginLiveGenuineEdgeTokenProtocolVersion,msEdgeLoginMicrosoftOnlineGenuineEdgeTokenProtocolVersion,msGraphMicrosoftGECHeader,msLoginLiveGECHeader,msLoginMicrosoftOnlineGECHeader"
