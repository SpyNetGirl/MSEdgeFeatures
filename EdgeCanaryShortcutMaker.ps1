...
$FullVersionToUse = "152.0.4148.0"

$Arguments = "--enable-features=msoridCopilotDeviceFileUploadEnabled,msoridCopilotDeviceReadEnabled,msoridCopilotDeviceSearchEnabled,msoridCopilotDeviceWriteEnabled"
