...
$FullVersionToUse = "155.0.4266.0"

$Arguments = "--enable-features=msCompactNeutralThemeAppliedTrigger,msCompactThemedThemeAppliedTrigger,msDefaultBlueThemeAppliedTrigger,msEEUseHeadMarkerFallbackClassifier,msEEUseLogisticProductPageClassifier,msNonColorThemeAppliedTrigger,msOneAuthWAMOnWCOS"
