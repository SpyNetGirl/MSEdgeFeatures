...
$FullVersionToUse = "149.0.4002.0"

$Arguments = "--enable-features=msEdgeDisableJavascriptOptimizer,msEdgeShoppingTemplateBFBypass,msNurturingUndefinedFeaure,msPolicyBtr,msRubyDisabledNtpOrDhpNavigation,msRubyDisabledNtpOrDhpStartNavigation,msRubyEnabledNtpOrDhpNavigation,msRubyEnabledNtpOrDhpStartNavigation,msVisualRejuvMicaTrigger,msWebUIUnifiedSignin"
