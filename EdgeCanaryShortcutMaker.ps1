...
$FullVersionToUse = "145.0.3790.0"

$Arguments = "--enable-features=ms2KE1,ms2KtCH,msCopilotBasedNTP,msDlpUseOneDriveForMAMDownloadBlock,msStudioDhpStartNavigation,msStudioNonPrerenderDhpStartNavigation,msStudioNonPrerenderNtpNavigation,msStudioNonPrerenderNtpOrDhpStartNavigation,msStudioNonPrerenderNtpOrPostFreDhpNavigation,msStudioNonPrerenderNtpStartNavigation,msStudioNonPrerenderPostFreDhpNavigation,msStudioNtpNavigation,msStudioNtpOrDhpStartNavigation,msStudioNtpOrPostFreDhpNavigation,msStudioNtpStartNavigation,msStudioPostFreDhpNavigation,msStudioPrerenderDhpStartNavigation,msStudioPrerenderNtpNavigation,msStudioPrerenderNtpOrDhpStartNavigation,msStudioPrerenderNtpOrPostFreDhpNavigation,msStudioPrerenderNtpStartNavigation,msStudioPrerenderPostFreDhpNavigation"
