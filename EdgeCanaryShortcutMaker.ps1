...
$FullVersionToUse = "144.0.3659.0"

$Arguments = "--enable-features=msCopilotApisFileSearch,msEdgeCopilotGlobalHotkey,msEdgeLoginFormPageLoadTrigger,msEdgeMPMPasskeyAssertTrigger,msEdgeMPMPasskeyCreateTrigger,msEdgeMPMPasskeyImmediateMediationTrigger,msEdgeMPMWebAuthnFieldPageLoadTrigger,msEdgeToolsPageStabilityMonitor"
