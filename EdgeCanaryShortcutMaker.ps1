...
$FullVersionToUse = "156.0.4295.0"

$Arguments = "--enable-features=msExtensionsFeedbackProto,msOpenTabsFallbackConsumerNewTab,msOpenTabsFallbackConsumerNewTabNoImport"
