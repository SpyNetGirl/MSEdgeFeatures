...
$FullVersionToUse = "142.0.3565.0"

$Arguments = "--enable-features=msEdgeSearchboxHandlerSendsFaviconData,msExplicitLaunchNonBingDSE,msExplicitLaunchNonBingDSEAndNonEdgeDB,msExplicitLaunchNonEdgeDB,msSettingsMatchWordStart,msWSBLaunchNonBingDSE,msWSBLaunchNonBingDSEAndNonEdgeDB,msWSBLaunchNonEdgeDB"
