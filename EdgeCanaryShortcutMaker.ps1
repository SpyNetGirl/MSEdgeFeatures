...
$FullVersionToUse = "141.0.3518.0"

$Arguments = "--enable-features=msEdgeCopilotModeSkipAccessGate,msEdgeOmniboxNavigateToEdgeChat,msExtensionsSitePermissionsRevamp"
