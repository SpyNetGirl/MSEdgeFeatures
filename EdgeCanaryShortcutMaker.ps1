...
$FullVersionToUse = "143.0.3650.0"

$Arguments = "--enable-features=msMdaProtectedClipboard,msMdaProtectedClipboardPolicy,msOmniboxASUpdatedEntryPointTrie,msPdfOverrideSharedLibrary,msSecureIPBandwidthTelemetry"
