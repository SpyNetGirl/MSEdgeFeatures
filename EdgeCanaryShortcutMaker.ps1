...
$FullVersionToUse = "152.0.4169.0"

$Arguments = "--enable-features=msEdgeAccountNameEmailProfile,msEdgeBrowserHasslesExtensionsShowUx,msEdgeCopilotCrReadAllScope,msEdgeCopilotIframelessInteractiveAuth,msSwapPreProd"
