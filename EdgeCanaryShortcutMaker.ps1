...
$FullVersionToUse = "147.0.3908.0"

$Arguments = "--enable-features=msEdgeAutofillCopilotProfileQualityTreatmentA,msEdgeAutofillCopilotProfileQualityTreatmentB,msEdgeAutofillCopilotSuggestions,msEdgeBrowserHasslesRefreshFunctionalTrigger,msEdgeBrowserHasslesTriggerHub"
