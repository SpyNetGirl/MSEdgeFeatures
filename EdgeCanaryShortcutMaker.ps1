...
$FullVersionToUse = "148.0.3967.0"

$Arguments = "--enable-features=MsW59J,MsWShG,msBrowserSideAreaSelection,msCopilotComponentExtensionAllowlist,msEdgeJourneysComparisonMode,msEdgeSuperDragDefaultEnabledChina,msEdgeSuperDragDropSupportedChina,msSusCmdUrlFgDetection"
