...
$FullVersionToUse = "144.0.3691.0"

$Arguments = "--enable-features=MSCopilot,MSCopilotDev,MSCopilotInternal,msEdgeFeedbackIncludeFlightLogs,msSegmentationPlatformUrlInterestsJustInTimeCopilotAudienceFeature,msTechScamBlockingToggleOffByDefault"
