...
$FullVersionToUse = "147.0.3887.0"

$Arguments = "--enable-features=msEdgeComposeCopilotChat,msEdgeMetaOSAppServiceUseLoginHint,msEdgeNotPinnedToTaskbarTrigger,msEdgeTaskbarPinCheck,msShowBrowserCustomizationHubEntryPoint"
