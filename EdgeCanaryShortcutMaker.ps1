...
$FullVersionToUse = "150.0.4044.0"

$Arguments = "--enable-features=MSRtE1,msCookiesSelectedForImport,msEntertainmentChinaMinAppNetworkUsageMB,msNurturingIncludeProngsInWSBTarget,msNurturingProngsTrigger,msPasswordsSelectedForImport,msPaymentsSelectedForImport"
