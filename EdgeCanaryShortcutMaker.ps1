...
$FullVersionToUse = "142.0.3586.0"

$Arguments = "--enable-features=MsCopilot,MsCopilotConfigurations,MsCopilotPrivacy,MsCopilotSharedConversations,msArbitrationServiceExtensionsLogger,msStudioNTPBypassChecksForTesting"
