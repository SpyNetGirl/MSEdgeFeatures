...
$FullVersionToUse = "147.0.3890.0"

$Arguments = "--enable-features=msEdgeSpaceworksInlineWindowSwitching,msNurturingAdditionalWsbParams,msWChromiumAllowServerChatSuggestions,msWebView2DevToolsHeaderClient"
