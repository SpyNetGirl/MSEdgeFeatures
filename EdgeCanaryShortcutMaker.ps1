...
$FullVersionToUse = "153.0.4211.0"

$Arguments = "--enable-features=msCopilotNaaInteractiveAuthQueue,msCopilotNaaSilentAuthCoalescing,msDisableCrHostAuthPrivate,msDisableCrHostInteractiveAuth"
