...
$FullVersionToUse = "141.0.3522.0"

$Arguments = "--enable-features=msEdgeShoppingDisableDefaultExperience,msHistoryActiveVisitDuration,msTechScamSensorNetworkToggleOnByDefault,msUndersideChatTopChrome"
