...
$FullVersionToUse = "146.0.3819.0"

$Arguments = "--enable-features=mSamplesH,msCISettingsToggleRow,msEdgeSunflowerEnableNewImportUI,msEdgeWebView2HideContentsContainerBorder,msForceNoRoundedCornerAndMargin,msHandleCIActivatedOnRemote,msImportOpenTabsFromChromeWithFileLocked,msSpawnNtpOnLastTabClosePrefsCleanup"
