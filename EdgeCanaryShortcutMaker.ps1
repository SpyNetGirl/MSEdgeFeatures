...
$FullVersionToUse = "150.0.4075.0"

$Arguments = "--enable-features=msCopilotBackgroundRestartManager,msCopilotBackgroundRestartManagerCanRestart,msCopilotBackgroundRestartManagerDisableIfExtensionsLoaded,msEdgeWebAuthnEnclaveAuthenticatorDefault"
