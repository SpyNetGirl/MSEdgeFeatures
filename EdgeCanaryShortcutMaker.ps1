...
$FullVersionToUse = "142.0.3561.0"

$Arguments = "--enable-features=msBrowserLaunchDaysSinceCICompletedTrigger,msSegmentationPlatformDaysSinceCICompletedOverrideForTesting"
