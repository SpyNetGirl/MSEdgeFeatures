...
$FullVersionToUse = "143.0.3638.0"

$Arguments = "--enable-features=msArbitrationServiceCopilotModeSuppression,msEdgeDownloadChromeInterceptPinpointGamingTrigger,msEdgeDownloadChromeInterceptPinpointGeminiTrigger,msEdgeDownloadChromeInterceptPinpointShoppingTrigger,msEdgeDownloadChromeInterceptPinpointStreamingTrigger"
