...
$FullVersionToUse = "141.0.3498.0"

$Arguments = "--enable-features=msEdgeJourneyEnabledForciblyForTesting,msHistorySearchSupported,msLotusLatchCampaignAsterEngagedUser,msLotusLatchCampaignNetworkPBTrigger,msLotusLatchCampaignNotAsterEngagedUser,msLotusLatchCampaignSignalOptimization,msSkipAutolaunchInCopilotMode,msSkipCIOpenTabsImportInCopilotMode"
