...
$FullVersionToUse = "153.0.4229.0"

$Arguments = "--enable-features=msEdgeCopilotHarmonyNaaRequestShape,msEdgeIntentsNurturing,msEdgeTranslateGenuineEdgeHeaders,msEdgeTranslateGenuineEdgeTokenProtocolVersion"
