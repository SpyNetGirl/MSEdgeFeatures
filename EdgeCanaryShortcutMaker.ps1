...
$FullVersionToUse = "141.0.3509.0"

$Arguments = "--enable-features=msCopilotENCInlineBrowsing,msEdgeExtensionsDetectorIssueDetected,msEdgeFeedbackIncludeENPArbitrationLogs,msEdgeImmersiveSoftFREInRTL,msLotusLatchCampaignHighlyEngagedAsterPivotedTrigger,msPinningCampaignAsterUsageTrigger,msPinningCampaignLowEdgeEngagementTrigger,msTargetingWithConfiguredAsterBrowserUsage,msWebUISyncConfirmationDialog,mssellaitnede"
