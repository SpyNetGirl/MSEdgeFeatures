...
$FullVersionToUse = "141.0.3524.0"

$Arguments = "--enable-features=msDlpEnterpriseWatermarkingPrint,msEdgeJourneysKeepHistorySynchronized,msEdgeJourneysUseOldHistoryDuration,msSpeechRecognitionChromiumNetworkStack"
