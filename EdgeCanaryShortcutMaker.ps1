...
$FullVersionToUse = "144.0.3688.0"

$Arguments = "--enable-features=msCopilotModeUpsellCooldownOverride,msWhatsNewContentVisibleCopilotModeUpsellCooldownPassed,msWhatsNewPageCopilotModeUpsellCooldownPassed"
