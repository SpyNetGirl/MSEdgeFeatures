...
$FullVersionToUse = "149.0.3981.0"

$Arguments = "--enable-features=msCopilotWebSourceTracker,msEdgeComposeVoiceInput,msEdgeWorkJourneysTop3OnNtp,msNurturingMSStartYJCompeteTextVolumn,msV2StaticSitesForENPPinning,msWebUIBlueprint"
