...
$FullVersionToUse = "145.0.3731.0"

$Arguments = "--enable-features=MsNWPdQNRaR,msEdgeCollectionsUnship,msIncludeBreadcrumbsInFeedback,msIncludeExperimentsInfoInFeedback,msPostKeepAliveInOsUpgrade"
