...
$FullVersionToUse = "145.0.3743.0"

$Arguments = "--enable-features=MsNWPdQNRaR,msDlpProtectedDownloadsBannerForTesting,msEdgeToolsCleanupTimeout,msEdgeToolsDomainActionsOverride"
