...
$FullVersionToUse = "148.0.3952.0"

$Arguments = "--enable-features=msAutoLaunchSuppressedSession,msEdgeSessionRestoreLogger,msEdgeToolsBlockNavigationToIpAddressUrls,msInteractiveReadAloudCEP,msSendCustomSignalsInClientDataHeader,msStartCIInAutolaunchSuppression"
