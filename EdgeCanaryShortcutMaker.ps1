...
$FullVersionToUse = "150.0.4074.0"

$Arguments = "--enable-features=msEdgeIframelessChatCommercialSidepane,msEdgeIframelessChatConsumerSidepane,msEdgeSearchHistoryMultiWordAllowAutocomplete,msEdgeSearchHistoryMultiWordVisitCountThreshold,msSegmentationPlatformUrlInterestsJustInTimeFootballFifa"
