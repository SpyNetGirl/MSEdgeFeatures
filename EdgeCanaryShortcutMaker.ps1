...
$FullVersionToUse = "153.0.4224.0"

$Arguments = "--enable-features=msEdgeAgentHostFreezeHold,msEdgeAgentHostFreezeHoldTimeout,msNurturingMSStartYJCompeteTextVolumn"
