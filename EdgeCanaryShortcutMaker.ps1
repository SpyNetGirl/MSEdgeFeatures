...
$FullVersionToUse = "153.0.4230.0"

$Arguments = "--enable-features=msCopilotCodeTabRuntimeKillSwitch,msEdgeIntentsFlyoutNotification,msEdgeNDFREShorterStringExp,msEdgeToolsScreenshotSensitiveRedactionUseBlur"
