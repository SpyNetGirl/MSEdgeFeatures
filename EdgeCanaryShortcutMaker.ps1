...
$FullVersionToUse = "141.0.3520.0"

$Arguments = "--enable-features=msEdgeAutofillServerVersion,msEdgeAutofilledValueAcceptedHandlerAutofillCore,msEdgeAutofilledValueAcceptedHandlerPassword,msEdgeBackgroundRestartManagerDisableIfExtensionsLoaded,msEdgeUCNtpCardsIgnoreMinCards,msTechScamSensorNetwork"
