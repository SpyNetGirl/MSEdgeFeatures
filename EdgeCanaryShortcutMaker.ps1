...
$FullVersionToUse = "153.0.4217.0"

$Arguments = "--enable-features=msDesktopModeSnipToSearchIcon,msEdgeDlpInCopilotApp,msEdgeToolsAgentTabOffscreenHosting,msWebView2DirectExecuteScript"
