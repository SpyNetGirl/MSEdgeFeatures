...
$FullVersionToUse = "144.0.3660.0"

$Arguments = "--enable-features=msBrowserLaunchExternalHttpLinkTrigger,msBrowserLaunchExternalPdfTrigger,msBrowserLaunchOtherExternalFileTrigger,msBrowserLaunchOtherExternalProtocolTrigger,msCopilotENCSidepaneOverride,msSendPayloadIdInClientDataHeader"
