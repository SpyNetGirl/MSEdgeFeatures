...
$FullVersionToUse = "154.0.4255.0"

$Arguments = "--enable-features=msEdgeEfficiencyModeChildProcessBatterySaver,msEdgeGlobalFrameRateThrottling,msEdgeGlobalFrameRateThrottlingFrameRateHz,msEdgeSelectPassword,msEdgeToolsCoworkReviewHostSidePanel,msNetErrorPageC1BFeatures"
