...
$FullVersionToUse = "151.0.4099.0"

$Arguments = "--enable-features=msEdgeAutofillPopupCheckHtmlFormPopupOverlap,msNurturingOmniboxReadingViewEducation,msOnDeviceModelWebGpuGraphCapture"
