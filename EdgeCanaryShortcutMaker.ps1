...
$FullVersionToUse = "146.0.3832.0"

$Arguments = "--enable-features=msComposerTyped,msEdgeAutofillTools,msEdgeVpnEnabled,msInteractiveReadAloud,msOmniboxDraggableEmptyArea,msWebViewAllowLocalNetworkAccessChecks"
