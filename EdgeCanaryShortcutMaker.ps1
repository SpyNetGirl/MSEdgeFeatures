...
$FullVersionToUse = "149.0.4007.0"

$Arguments = "--enable-features=msCookieStoragePreconditionMetTrigger,msCookieStorageStrategyFiredTrigger,msEdgeBrowserHasslesCookieStorageShowUX,msEdgeBrowserHasslesCookieStorageTrigger,msEdgeLLMOnDeviceModelMuffinToolUseWorkaround,msNurturingFNCopilotModeFlyout,msTPStrictRefreshPreconditionMetTrigger,msTPStrictRefreshStrategyFiredTrigger"
