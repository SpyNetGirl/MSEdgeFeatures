...
$FullVersionToUse = "144.0.3692.0"

$Arguments = "--enable-features=msDiscoveredCookiesForImport,msDiscoveredPasswordsForImport,msDiscoveredPaymentsForImport,msEdgeSafeHostingExtension,msFunctionIntegrityValidation,msImportAsterAppBoundEncryptedData,msNurturingEdgeCopilotJitCM,msOnDeviceSpeechRecognition,msPaymentsImportStarted"
