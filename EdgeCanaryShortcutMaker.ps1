...
$FullVersionToUse = "149.0.3992.0"

$Arguments = "--enable-features=msEdgeCopilotPrivateSendQuery,msEdgeRendererHardFaultsMetrics,msEdgeToolsBrowserSandbox,msEdgeTriggerPasswordResyncForUndecryptablePasswords"
