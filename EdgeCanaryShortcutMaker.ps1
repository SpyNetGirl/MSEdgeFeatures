...
$FullVersionToUse = "145.0.3787.0"

$Arguments = "--enable-features=mSvKE1,msEdgeMediaControlsPlayMediaAndHoverOnTaskbar,msPrintPreviewExplicitCleanupOnException,msPrintPreviewJsExceptionEncountered"
