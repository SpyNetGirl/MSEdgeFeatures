...
$FullVersionToUse = "143.0.3604.0"

$Arguments = "--enable-features=msEdgeToolsBypassCopilotMode,msEdgeToolsForCommercialChat,msEnableConfigureFeatureFlagsOverrides"
