...
$FullVersionToUse = "146.0.3844.0"

$Arguments = "--enable-features=msAutofillEdgeCouponsAutoApply,msBingReplaceLanguageURLQueryParameter,msComposerOuterframeTextBuffer,msComposerOuterframeTextBufferVisibility,msDesktopModeExplicitOptin,msEdgeMediaControlsShowThumbnail,msEnabledProviders,msM365LinkInsightsForOutlookTrigger"
