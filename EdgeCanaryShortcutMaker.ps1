...
$FullVersionToUse = "147.0.3883.0"

$Arguments = "--enable-features=msEdgeAsterDeferredKeyDecryption,msEdgeCopilotNtpDailyRefreshBackground,msEdgeDownloadInterceptCIConsent,msEdgeReaderModeWebUI2ViewerInitialized,msFeatureMmxUpsellRewards1MLottery,msMipUseCustomFeatureSettings,msMipValidatePublishingLicenseSignature,msPasswordBreachScanThrottleDisabled,msSegmentationPlatformClientSignalsFeature,msSettingsLazyLoadProfileAvatarIcons"
