...
$FullVersionToUse = "144.0.3684.0"

$Arguments = "--enable-features=msCopilotClientIDForMSA,msCopilotQueryTabGroups,msCopilotTips,msEdgeThemeServiceDarkMode,msEdgeUndersideV2WorkerSrcCSP,msPreloadTopChromeWebUI,msUCNtpBackgroundAAD"
