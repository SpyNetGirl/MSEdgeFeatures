...
$FullVersionToUse = "143.0.3619.0"

$Arguments = "--enable-features=msDefaultAppSettingsInfoBar,msEdgeGrowthRefreshedExperience,msEdgePinpointFramework,msUnseasonedPrintPreview"
