...
$FullVersionToUse = "149.0.4004.0"

$Arguments = "--enable-features=msDcpdfIrmV1Support,msEdgeInterceptIconExperiment,msEdgeInterceptIconExperimentTreatmentParam,msSwagM1Google"
