...
$FullVersionToUse = "144.0.3718.0"

$Arguments = "--enable-features=msEdgeDownloadContextualBanditForIntercept,msEdgeDownloadContextualBanditForInterceptLinkId,msEdgeDownloadContextualBanditForInterceptTreatmentParam,msNewTabPageTriggerForPrerender2"
