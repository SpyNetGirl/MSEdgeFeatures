...
$FullVersionToUse = "150.0.4058.0"

$Arguments = "--enable-features=msDataUpdateInterval,msDisplayInterval,msInitialDelay,msSearchBoxInToolbarTrendingRotation,msUseV2Api"
