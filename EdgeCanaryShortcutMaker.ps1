...
$FullVersionToUse = "155.0.4268.0"

$Arguments = "--enable-features=msDefaultThemeEverAppliedTrigger,msEdgeBrowserHasslesExtensionContentScriptTrigger,msEdgeBrowserHasslesExtensionContentScriptTriggerHubAA,msLazyLoadOneAuthInWebView,msNurturingUndefinedFeaure"
