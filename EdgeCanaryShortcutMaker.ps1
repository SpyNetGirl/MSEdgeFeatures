...
$FullVersionToUse = "141.0.3500.0"

$Arguments = "--enable-features=msEdgeCopilotInHelpMoreMenuAndShortcutNoRedirectionEnabled,msEdgeCopilotInHelpMoreMenuAndShortcutWithRedirectionEnabled,msNtpVNextBackground,msPersonalizedLaunchExactMatchQuery,msWritesDmaSchemaToAllIndexers"
