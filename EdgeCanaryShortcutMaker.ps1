...
$FullVersionToUse = "154.0.4245.0"

$Arguments = "--enable-features=msCardRoamingMSAv2,msEdgeReadingModeExtractionImprovements,msEdgeSkipPreReadMainDllWhileWindowless,msEdgeSuppressPreReadMainDllWhenNoActiveBrowser,msMsnNtpRendererFamilyOverrideForTesting,msOmniboxQFAcceptedAtLeastOncePerDay,msOmniboxQFAcceptedAtLeastTwicePerDay,msOmniboxZIAcceptedAtLeastOncePerDay,msOmniboxZIAcceptedAtLeastTwicePerDay,msSegmentationPlatformDefaultsNotificationTriggeringModelUseCU"
