...
$FullVersionToUse = "143.0.3648.0"

$Arguments = "--enable-features=msEdgeAutofillMlUnifiedSettings,msEdgeExportToExcel,msIEModeWindowModalDialogs,msNurturingEdgeCopilotJitEdu,msWebUIAgentWebcontentsOverlayV2"
