...
$FullVersionToUse = "149.0.4005.0"

$Arguments = "--enable-features=msEdgeBrowserHasslesThirdPartyCookieShowUx,msEdgeBrowserHasslesThirdPartyCookieTrigger,msThirdPartyCookiePreconditionMetTrigger,msThirdPartyCookieStrategyFiredTrigger"
