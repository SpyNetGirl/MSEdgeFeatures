...
$FullVersionToUse = "147.0.3900.0"

$Arguments = "--enable-features=msEdgeComposeDebug,msEdgeFeedbackOdsPetrolDualSubmission,msEdgeShowCredentialManagerAccountChooser,msEdgeSiteOptimizationHints,msEmxFetchWcfTasksWithOSAuthTokensKillSwitch,msWebUIVisionShyBar"
