...
$FullVersionToUse = "150.0.4041.0"

$Arguments = "--enable-features=msBrowserHasslesSiteStatusSubpageOpenedTrigger,msEdge3pSerpMultiConfigInstaller,msEdgeCookieDeferredKeyIPCRefactor,msEdgeDownloadContextualBanditForInterceptBodyText,msEdgeDownloadContextualBanditForInterceptCtaText,msGdiScreenForceFallbackIfServiceNotReturned,msSettingsLazyLoadNonProfilesComponents"
