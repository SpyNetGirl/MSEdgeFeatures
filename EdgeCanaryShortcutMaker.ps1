...
$FullVersionToUse = "145.0.3753.0"

$Arguments = "--enable-features=msEdgeDownloadInterceptVisibility,msEdgeDownloadInterceptVisibilityTreatmentParam,msM365LinkInsights,msM365LinkInsightsSourceType,msOmniboxActionVisualSearch,msOmniboxBlockSensitiveLocalhostCopy,msOmniboxComposerReformulationUx"
