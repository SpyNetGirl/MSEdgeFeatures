...
$FullVersionToUse = "145.0.3785.0"

$Arguments = "--enable-features=msElevatedSettingsLabelRename,msNurturingGuidedDialogAccepted,msSettingsCenterSearchBar,msSettingsElevatedTopSettings"
