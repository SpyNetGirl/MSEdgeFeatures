...
$FullVersionToUse = "143.0.3630.0"

$Arguments = "--enable-features=msEdgeToolsIncrementCaptureCountOnTabLock,msEdgeToolsScreenshotForceRedrawFrame,msEdgeToolsScreenshotForceRepaintFrame,msSegmentationPlatformBrowserUsageThreshold"
