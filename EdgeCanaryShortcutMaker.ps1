...
$FullVersionToUse = "153.0.4227.0"

$Arguments = "--enable-features=msDelayLoadSandboxPolicy,msEdgeAutofillComplexFormDetection,msSkipSnapDelayLoadsInBrowserProcess,msSkipSnapDelayLoadsInRenderProcess,msSnapDelayLoads"
