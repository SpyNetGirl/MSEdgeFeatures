...
$FullVersionToUse = "144.0.3664.0"

$Arguments = "--enable-features=msBrowserLaunchEqualTrigger,msBrowserLaunchWWETrigger,msBrowserLaunchWWUTrigger,msCloudPolicyV2Tasks,msCopilotMigrateXamlPref,msEdgeAtlasDownloadBingReferrerHideIntercept,msEdgeAtlasDownloadIntercept,msEdgeAtlasDownloadInterceptTreatmentParam,msEdgePermissionPromptInTopChrome,msEnableExtensionServiceWorkerGetVote,msNurturingRecommendedSettingsGuidedDialog,msPasswordBreachScanThrottleDisabled,msSecureIPAllUsers,msTextPredictionThreshold,msVisualRejuvMicaTrigger"
