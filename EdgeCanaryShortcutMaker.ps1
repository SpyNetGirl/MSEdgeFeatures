...
$FullVersionToUse = "145.0.3726.0"

$Arguments = "--enable-features=msDesktopModeTrendingZeroInputV2,msEdgeAffiliatedPasswordSuggestions,msEdgeAffiliationBackend,msNTPHideRecSites,msNTPHideTopSites"
