...
$FullVersionToUse = "142.0.3589.0"

$Arguments = "--enable-features=msClickId,msCloudProfileReporting,msCloudProfileReportingIncludeAllData,msEdgeShoppingCashbackDataToCopilot,msSegmentationPlatformUrlInterestsCustom3LookBehindFeature,msSegmentationPlatformUrlInterestsCustom4LookBehindFeature,msSegmentationPlatformUrlInterestsCustom5LookBehindFeature"
