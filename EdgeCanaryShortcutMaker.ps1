...
$FullVersionToUse = "144.0.3662.0"

$Arguments = "--enable-features=msBypassActionsRequiredAllowListTreatmentEnabled,msSegmentationPlatformUserJourneyExecutionCadenceSeconds,msSegmentationPlatformUserJourneyFeature,msSegmentationPlatformUserJourneyFreshnessInMinutes,msSegmentationPlatformUserJourneyInitialExecutionDelaySeconds,msSegmentationPlatformUserJourneyModelVersion,msWebUIBrowserHassles"
