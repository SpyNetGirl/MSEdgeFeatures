...
$FullVersionToUse = "143.0.3634.0"

$Arguments = "--enable-features=msBrowserLaunchAnotherAppPinnedSiteTrigger,msBrowserLaunchPinnedSiteUserTrigger,msBrowserLaunchStartMenuPinnedSiteTrigger,msBrowserLaunchTaskbarPinnedSiteTrigger,msEdgeUndersideVideoSummaryLabel,msMdaScreenCapture"
