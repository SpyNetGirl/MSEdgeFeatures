...
$FullVersionToUse = "145.0.3761.0"

$Arguments = "--enable-features=msBrowserCustomThemeTrigger,msBrowserHighContrastModeTrigger,msBrowserHorizontalTabsTrigger,msBrowserVerticalTabsTrigger,msEdgeAutofillEnhancedAutofill,msEdgeInterstitialWWESupressSoftFREInternal,msRecordUcpdStatusOnNav"
