...
$FullVersionToUse = "145.0.3728.0"

$Arguments = "--enable-features=msEdgeCrossButtonForNewProfileFRE,msEdgeIncludeGPUInfoLogInFeedback,msEdgeIncludeMediaInternalsLogInFeedback,msOmniboxRefineSEAutocomplete,msWalletCheckoutAutofillDriverWebUI2"
