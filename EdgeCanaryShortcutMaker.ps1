...
$FullVersionToUse = "144.0.3674.0"

$Arguments = "--enable-features=msPdfUpsellLabelUpdate,msSpawnNtpOnLastTabCloseInChina,msSpawnNtpOnLastTabClosePrefsDefaultOnInChina,msUnknownLanguagePageAfterNoOfferNavigation"
