...
$FullVersionToUse = "145.0.3800.0"

$Arguments = "--enable-features=msEnableLotusLatchCampaignPrecomputationService,msLotusLatchCampaignTAMIncrease,msPinningCampaignsOverallTAMIncrease"
