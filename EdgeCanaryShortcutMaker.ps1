...
$FullVersionToUse = "151.0.4088.0"

$Arguments = "--enable-features=msDisableGwpAsanOnLowMemoryDevices,msNurturingDefaultPDFInfobar,msNurturingPdfInfobarChromeUsage50Trigger,msNurturingPdfInfobarChromeUsage90Trigger,msNurturingPdfInfobarEligibleTrigger,msNurturingPdfInfobarTrigger"
