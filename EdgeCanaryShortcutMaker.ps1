...
$FullVersionToUse = "149.0.4008.0"

$Arguments = "--enable-features=msEdgeBrowserHasslesCookieStorageTriggerHubAA,msEdgeBrowserHasslesThirdPartyCookieTriggerHubAA,msSwagM1Apple"
