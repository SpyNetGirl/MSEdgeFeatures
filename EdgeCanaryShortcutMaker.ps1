...
$FullVersionToUse = "152.0.4131.0"

$Arguments = "--enable-features=msEdgeClearDataOnExitPolicyOnlyMode,msEdgeJourneysUseUnifiedBackend,msSwapInMaxAttempts,msSwapMustCompress,msSwapOutDelaySeconds,msTopChromeWebUIPreloadedTrigger"
