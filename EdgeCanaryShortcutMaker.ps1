...
$FullVersionToUse = "150.0.4070.0"

$Arguments = "--enable-features=msBackNtpNavigation,msEdgeDefaultBrowserChangedToast,msForwardNtpNavigation,msOnDeviceModelPrefillCaching,msPrerenderBackNtpNavigation,msPrerenderForBackForwardNavigation,msPrerenderForwardNtpNavigation"
