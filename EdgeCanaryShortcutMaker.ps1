...
$FullVersionToUse = "150.0.4076.0"

$Arguments = "--enable-features=msEdgePurviewDlpGenuineEdgeTokenProtocolVersion,msEdgeShoppingPersistentStorage,msOmniboxGuaranteedHistoryURLSlots,msWebView2SolidColorLayerBackground"
