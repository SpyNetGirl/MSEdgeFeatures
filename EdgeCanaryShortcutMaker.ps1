...
$FullVersionToUse = "152.0.4181.0"

$Arguments = "--enable-features=msEdgeCIconRefresh,msEdgeCopilotBridgeCoworkMsa,msEdgeWebCaptureBtrMigration,msNurturingDSEResetNotification,msNurturingUndefinedFeaure,msPrintPreviewBtr"
