...
$FullVersionToUse = "153.0.4203.0"

$Arguments = "--enable-features=msColorThemeUserOnFirstCheckTrigger,msEdgeRewardsReportOfferOnLaunch,msEdgeSpaceworksSmartDefaults,msEdgeToolsCoworkAgentTabCloseConfirmation"
