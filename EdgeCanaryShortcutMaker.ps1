...
$FullVersionToUse = "148.0.3949.0"

$Arguments = "--enable-features=msBrowsingStreakReminderEligibleDays,msBrowsingStreakReminderMaxConsecutiveMisses,msBrowsingStreakReminderShortDwellThresholdSeconds,msEdgeM365PopupDecider"
