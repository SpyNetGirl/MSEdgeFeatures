...
$FullVersionToUse = "147.0.3896.0"

$Arguments = "--enable-features=MSPAuth,msAutolaunchActivationUpsell,msEdgeShoppingCombinedShoppingExperience,msEdgeToolsPageScreenshot,msNurturingAutolaunchInfobarAsterUsageQualifiedTrigger,msNurturingAutolaunchOnLaunchInfobarTrigger,msNurturingAutolaunchOnLaunchOptInVariant,msNurturingAutolaunchOnLaunchOptOutVariant,msOnDeviceSpeechRecognitionAPI"
