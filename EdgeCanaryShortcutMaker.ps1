...
$FullVersionToUse = "147.0.3879.0"

$Arguments = "--enable-features=msDesktopModeAppToAppDragAndDrop,msEdgeToolsScreenshotUsePrimaryMainFrame,msEdgeToolsWaitForVisualStateAfterScroll,msEdgeTranslationAPI,msInteractiveRolWordHighlight,msPdfFreeTextNonEnglishFontFix"
