...
$FullVersionToUse = "145.0.3788.0"

$Arguments = "--enable-features=msCacheLimitForTranslation,msCardRoamingCardExportMBISSLSAScope,msEnableTelemetryForWCF,msStringUMAFavoriteUrlTitleMismatch"
