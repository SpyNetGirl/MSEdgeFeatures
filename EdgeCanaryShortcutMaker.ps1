...
$FullVersionToUse = "150.0.4030.0"

$Arguments = "--enable-features=MsComposeInlineBlueDotParams,msAsterAppBoundDataSelectedForImport,msEdgeBrowserHasslesUntriggeredSubpage,msEdgeJourneysOnDeviceSummary,msEdgeToolsAutoLockRemoteTabs,msNurturingContextQueryOptimization,msNurturingDialogUpsell"
