...
$FullVersionToUse = "143.0.3625.0"

$Arguments = "--enable-features=msEdgePinningReorderForAsterInclined,msEdgeTranslateInAppMenuOnEnglishAppLocaleTrigger,msOmniboxTwoLineEntitiesAndAnswers,msWhatsNewCopilotModeUpsellVisible"
