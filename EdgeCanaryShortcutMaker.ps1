...
$FullVersionToUse = "155.0.4282.0"

$Arguments = "--enable-features=msEdgeAlignedEnergySaver,msEdgeCheckBulkDeleteCallerAllowed,msEdgeCopilotBridgeAutopilot,msEdgeEnergySaverLowBatteryConditionReachedTrigger,msEdgeEnergySaverUnpluggedTrigger,msEdgeInterceptSuppressTranslateBubble,msEdgeInterceptTranslateWouldShowOnChromeDownload,msEdgeReportEmptyPassword"
