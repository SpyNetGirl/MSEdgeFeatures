...
$FullVersionToUse = "149.0.4015.0"

$Arguments = "--enable-features=msEdgeToolsScreenshotSensitiveRedaction,msFamilySafetyInternalsBtr,msIntentionallyBreakAuthForTesting,msInteractiveReadAloudInOngoingVisionSession,msInteractiveReadAloudInOngoingVisionSessionCEP,msNtpExpUCRoutingControl,msNtpExpUCRoutingTreatment,msNtpUCRoutingOnMsnNtp,msNurturingMSStartYJCompeteTextVolumn,msPdfUndoRedo,msToolbarDeclutterIncludeFavorites"
