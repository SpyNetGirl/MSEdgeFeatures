...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 122.0.2339.0

### Last processed at: 01/14/2024 00:05:47 (UTC+00:00)
...
* msCacheBaseEntitySpecificsInMetadata
 * msContinuousImportSpecialHandlingForAADUsers
 * msDesktopModeAltSpace
 * msEdgeCopilotHistoryChatEnabled
 * msEdgeCopilotVisibleContextCalculation
 * msEdgeFeatureGroupENP
 * msEdgeFREThemesEdgeColorPicker
 * msEdgeTabOption
 * msEdgeUploadPasswordVotesAlways
 * msNtpFeedVisibleDhp
 * msNtpFeedVisibleNtp
 * msOmniboxPromoterForSidebarPWA
 * msPasswordLoginDbNewPath
 * msProauthReduceRequestsFromBackground
 * msTopSitesVisibleDhp
 * msTopSitesVisibleNtp
