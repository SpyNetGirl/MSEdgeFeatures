...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 133.0.2964.0

### Last processed at: 11/18/2024 16:26:00 (UTC+00:00)
...
* msPdfWebui2
 * msPdfEnablePDFReflowGatingFunction
 * msEdgeFREGDIV2Screen
 * msEdgeExportToExcel
 * msSidebarRemoveAutoHideVisibilityOptionEnabled
 * msPhoenixCustomThemeEnabled
 * msEdgeUndersideV2EligibilityPolling
 * msEdgeLightningBypassChromePreInstall
 * msProvenanceValidatorToggle
 * msProvenanceValidatorLocalDataRetentionDays
 * msEdgeSuperSafePinTab
 * msEdgePinTab
 * msSettingsThemesInstallAddOnsInRow
 * msDisableAbydosForPDF
 * msNtpUseGoogleTopSites
 * msLlmConsumerDlpNonCompliantBrowserBlocking
 * msFavoritesBackfillFavicon
 * msFavoritesBackfillFaviconRequest
 * msBingShortNameOmnibox
 * msBingShortNameOmniboxParam
 * msVisualCompanionAccessCheckHours
 * msVisualCompanionDisableSidebarSettings
 * msVisualCompanionDefaultPref
