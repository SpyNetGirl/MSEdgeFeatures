...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 120.0.2171.0

### Last processed at: 10/20/2023 00:34:20 (UTC+00:00)
...
* msAssetStoreReduceMetadataCacheDuration
 * msContinuousMigrationUploadImportedHistory
 * msEdgeSyncCheckCDUTConflict
 * msEdgeWalletMobileNotification
 * msMitigatingDLLInjectionPartnerCode
 * msNurturingDefaultBrowserBannerDSE
 * msNurturingUndersideBCEFlyoutFeature
 * msOmniboxPedalLightningImportChromeData
 * msVideoTranslateOverlayButton
 * msWalletInternalPage
