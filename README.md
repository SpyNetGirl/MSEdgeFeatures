...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 117.0.2031.0

### Last processed at: 08/10/2023 18:40:19 (UTC+00:00)

<details>
<summary>31 new features were added in the latest Edge Canary update</summary>

<br>

* msBrowserHiddenTitleBarTrigger
 * msChromeInstalled
 * msChromeInstalledandEdgePB
 * msEdgeExcelAutofillTabHint
 * msEdgeGamerModeNTPEntryPoint
 * msEdgePasswordAutocompleteDetectionImprovement
 * msEdgePasswordAutostuffSingleUsernameInSaveFlyout
 * msEdgePasswordUKMLogging
 * msEECaptureFrameForFavoritesV2
 * msensosiosuosiuosersusausiausiusysenyserys
 * mseser
 * msFindOnPageContextualResultsToDisplayThreshold
 * msHEVCWebCodecsEnabled
 * msImportEndedAfterAdvanceToCIConversion
 * msNurturingOnboardFNToCEEnabled
 * msNurturingRefactorVectorToMap
 * msOmniboxPedalInterceptChineseA2
 * msOmniboxPedalLocaleFilter
 * msOmniboxPedalSettingsChineseA2
 * msOmniboxRelatedSuggestionsToggle
 * msOnceTriggerForAdvanceConsent
 * msOnceTriggerForLadderUpDownExperiment
 * msPersonalizedCashbackShoppingMetadata
 * msPrioritizePersonalizedCashbackShoppingMetadata
 * msSegmentationPlatformEdgeValidationHistogramTriggeredExecution
 * msSegmentationPlatformEdgeValidationHistogramTriggerValue
 * msSegmentationPlatformEdgeValidationTriggerName
 * msSegmentationPlatformEdgeValidationUserActionTriggeredExecution
 * msShorelineSearchThisSiteScope
 * msWalletCheckoutDAFShippingOnly
 * msWorkspacesSkypeEntryPoints
