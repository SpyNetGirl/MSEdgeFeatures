...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 123.0.2420.0

### Last processed at: 02/23/2024 00:05:27 (UTC+00:00)
...
* msContinuousMigrationGenerateTopMediaList
 * msContinuousMigrationTopSiteServiceFetchMediaList
 * msEdgePrint
 * msEdgePrintPreview
 * msEdgeSearchBoxInToolbarOmnibox
 * msEnabledProviders
 * msFlexWeight
 * msMaxMatches
 * msMaxMatH
 * msMaxWidth
 * msSearchDiagnosticsTabsCombinationSignalTelemetry
 * msSimpleMatchView
