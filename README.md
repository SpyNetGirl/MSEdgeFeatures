...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 136.0.3210.0

### Last processed at: 03/22/2025 01:26:29 (UTC+00:00)
...
* msUACompatibilityDefaultFix
 * msLogNewDeviceModalFREAndSoftFRETelemetry
 * msSingleClickInstallThroughEasBingCards
 * msExtensionsGrowthInitiativeHoldout
 * msEdgeSettingsWalletWebui2
 * msEdgeMsbBingSearchRuntimeMessageFeature
 * msEdgeWorkSearchBanner
 * msEdgeWorkSearchBannerSharedExperiment
 * msPinnedSiteAction
 * msEdgeEnableVpnForWebRTC
 * msEdgePerformanceDetectorMoreMenu
 * msEdgeFeedbackEnableExportAllLogs
 * msTranslateVideoMFB
