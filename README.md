...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 128.0.2653.0

### Last processed at: 06/16/2024 00:05:43 (UTC+00:00)

<details>
<summary>26 new features were added in the latest Edge Canary update</summary>

<br>

* msEdgeAutofillSSAlgoV2
 * msEdgeHubAppStoreShorelinePersonalization
 * msEdgeShoppingTravel1
 * msEdgeShoppingTravel1Failure
 * msEdgeShoppingTravel1Success
 * msEdgeShoppingTravel2
 * msEdgeShoppingTravel2Failure
 * msEdgeShoppingTravel2Success
 * msEdgeShoppingTravel3
 * msEdgeShoppingTravel3Failure
 * msEdgeShoppingTravel3Success
 * msEdgeShoppingTravel4
 * msEdgeShoppingTravel4Failure
 * msEdgeShoppingTravel4Success
 * msEdgeShoppingTravel5
 * msEdgeShoppingTravel5Failure
 * msEdgeShoppingTravel5Success
 * msEdgeShoppingTravel6
 * msEdgeShoppingTravel6Failure
 * msEdgeShoppingTravel6Success
 * msEduDetectionGraphApiSkuNumber
 * msNextSuggestionsTopSitesVisible
 * msNextSuggestionsTopSitesVisibleDhp
 * msNextSuggestionsTopSitesVisibleNtp
 * msNurturingCEArbitrationDisabled
 * msShowNextSites
