...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 151.0.4087.0
### Last processed at: 06/11/2026 04:07:09 (UTC+00:00)
<details>
<summary>18 new features were added in the latest Edge Canary update</summary>

<br>

* msOneJSDhpStartNavigation
* msOneJSNonPrerenderDhpStartNavigation
* msOneJSNonPrerenderNtpNavigation
* msOneJSNonPrerenderNtpOrDhpStartNavigation
* msOneJSNonPrerenderNtpOrPostFreDhpNavigation
* msOneJSNonPrerenderNtpStartNavigation
* msOneJSNonPrerenderPostFreDhpNavigation
* msOneJSNtpNavigation
* msOneJSNtpOrDhpStartNavigation
* msOneJSNtpOrPostFreDhpNavigation
* msOneJSNtpStartNavigation
* msOneJSPostFreDhpNavigation
* msOneJSPrerenderDhpStartNavigation
* msOneJSPrerenderNtpNavigation
* msOneJSPrerenderNtpOrDhpStartNavigation
* msOneJSPrerenderNtpOrPostFreDhpNavigation
* msOneJSPrerenderNtpStartNavigation
* msOneJSPrerenderPostFreDhpNavigation
</details>
