...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 119.0.2124.0

### Last processed at: 09/26/2023 16:11:18 (UTC+00:00)
...
* msEdgeAutofillCrowdSourceBlocking
 * msEdgeAutofillRepeatableField
 * msEdgeAutoRefreshTokenShortInterval
 * msFloatyAutoLaunch
 * msM365AppOwaConfiguration
 * msNurturingRewardsRedemptionCoachmark1
 * msNurturingRewardsRedemptionCoachmark2
 * msNurturingRewardsRedemptionCoachmark3
 * msNurturingRewardsRedemptionCoachmark4
 * msNurturingRewardsRedemptionCoachmark5
 * msShowCampaignOnlyOnceFix
