...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 128.0.2728.0

### Last processed at: 07/22/2024 16:21:48 (UTC+00:00)
...
* msPdfTileCacheLimitBasedOnViewportSize
 * msEdgeSettingsSearch
 * msEdgeEcho
 * msEchoAppLoginUrlNavigated
 * msEchoAppJavascriptErrorDetected
 * msEchoAppCookiesDisabledErrorDetected
 * msEchoAppUnknownErrorWithCookiesDetected
 * msCreateSleepingSidePaneManager
 * msEdgeGMCLiveCaption
 * msEdgeSyncCosmicPPESelfHostRing
 * msEdgeSyncCosmicProdRing
 * msEdgeSyncSingleDeviceSessions
 * msEdgeSyncSingleDeviceExperiment
 * msEdgeAutofillPredictOTPFields
