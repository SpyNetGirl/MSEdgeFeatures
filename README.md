...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 149.0.4020.0
### Last processed at: 05/07/2026 02:59:33 (UTC+00:00)
<details>
<summary>19 new features were added in the latest Edge Canary update</summary>

<br>

* msEdge3PGoogleMapsSerpLogging
* msEdgeBtrRustHandler
* msEdgeCopilotExtensionPolicyBypass
* msEdgeCopilotSidebarBlocklistBypass
* msEdgeEnpDebugBtrMigration
* msEntertainmentChinaCampaignWindowDays
* msEntertainmentChinaLandingPageUrl
* msEntertainmentChinaMinTargetingSiteVisits
* msEntertainmentChinaReminderExpireDurationInDays
* msEntertainmentChinaReminderIntervalDays
* msEntertainmentChinaSkipRewardsReportingForTesting
* msEntertainmentChinaUrlHistoryFetchDurationInDays
* msNurturingMSStartYJCompeteTextVolumn
* msNurturingMediaControlsUpsellCustomTriggerAfterBasicTargetingCheck
* msNurturingSitePinningMediaControlsUpsell
* msNurturingSitePinningMediaControlsUpsellCustomTrigger
* msScannedPdfDetected
* msSegmentationPlatformEntertainmentChinaLaunchNotification
* msSegmentationPlatformIsEdgePrimaryOverrideForTesting
</details>
