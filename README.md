...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 119.0.2132.0

### Last processed at: 09/30/2023 16:09:33 (UTC+00:00)
...
* MSAKeyData
 * msEdgeAutofillIsFsdPrerequisiteForSs
 * msEdgeAutofillIsProfilePrerequisiteForSs
 * msEdgeSsOverrideAutocompleteCheck
 * msNurturingFieldTrialTestGroup
 * msNurturingFrameworkInInprivateMode
 * msOmniboxScopePickerOnTopInZI
 * msShorelineStandaloneSidebarRefetchManifest
 * msWalletHubBranding
 * msWalletHubGlobalHeader
 * msWalletHubNavRefresh
 * msWorkspacesVerticalTabsDefault
