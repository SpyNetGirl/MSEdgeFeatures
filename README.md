...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 118.0.2067.0

### Last processed at: 08/29/2023 00:33:00 (UTC+00:00)
...
* msCryptoWalletKeyringEnclaveV2MigrationEnabled
 * msEdgeGamerModeADSModalUX
 * msEdgeGamerModeOverrideIntegrityCheckForTesting
 * msEEPUClassificationUseOnlyHeuristics
 * msEEPUClassificationUseOnlyPageUnderstanding
 * msEEPUClassificationUsePageUnderstandingAndHeuristics
 * msFgBoostExtensionTrigger
 * msFgBoostPageKindMask
 * msFgBoostUnknownTrigger
 * msNurturingWorkspacesMsaTrySkypeChat
 * msPartnerBackgroundContentOffNTP
 * msPartnerContentOffNTP
 * msPartnerFeedHeadingsNTP
 * msUndersideWinCopilotUriHandler
 * msVideoSuperResMsVideoSuperResCapableTrigger
 * msVideoSuperResRightSizeTrigger
