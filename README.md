...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 122.0.2296.0

### Last processed at: 12/23/2023 00:05:28 (UTC+00:00)
...
* msAutofillEdgeExtraAttributesForPasswordHeuristics
 * msCryptoWalletKeyringProtoApi
 * msEdgeAutofillDedupTelemetryUsingUKMs
 * msEdgeAutofillFieldValueTelemetry
 * msEdgeAutoOpenRedDotNotification
 * msEdgeBrowserEssentialsShowExtensionsSection
 * msEdgeCopilotOverrideDeactivationTimer
 * msEdgeHJEnableSavingActionEvents
 * msEnable3PTelemetryObserver
 * msEnablePinningWithWindowsConsentOneSite
 * msEnablePinningWithWindowsConsentTwoSite
 * msFindOnPageDOMMutationObserver
 * msGenericIconSidebarButton
 * msHubAppsAutoOpenInternals
 * msNurturingDummyUIErrorCampaign
 * msNurturingKeepAliveForIrisFetcherEnabled
 * msNurturingPictureInPicture
 * msNurturingSitePinningWithWindowsConsent
 * msNurturingSitePinningWithWindowsConsentCustomTrigger
 * msVisualRejuvMicaTrigger
 * msWinCopilotSendFileToChat
