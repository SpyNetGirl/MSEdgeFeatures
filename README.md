...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 149.0.3975.0
### Last processed at: 04/13/2026 17:05:56 (UTC+00:00)
<details>
<summary>15 new features were added in the latest Edge Canary update</summary>

<br>

* msCopilotConversationHistory
* msCopilotNtpUpsellEdgePBUrlInterestGroupNtpOrDhpNavigation
* msCopilotNtpUpsellNonEdgePBUrlInterestGroupNtpOrDhpNavigation
* msCopilotNtpUpsellUrlInterestGroupNtpOrDhpNavigation
* msEdgeStudioNTPTipsSuggestions
* msEdgeWindowsWelcomeUpdateExpSignal
* msEdgeWindowsWelcomeUpdateFwlinkId
* msEnableMacPasskeySignIn
* msForceNtpPrerenderForTesting
* msNtpCopilotNtpUpsell
* msNtpCopilotNtpUpsellEdgePB
* msNtpCopilotNtpUpsellFeedEngaged
* msNtpCopilotNtpUpsellNonEdgePB
* msNtpCopilotNtpUpsellNotFeedEngaged
* msNurturingCopilotNtpUpsellOnNtp
</details>
