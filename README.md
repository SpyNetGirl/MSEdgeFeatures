...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 117.0.2026.0

### Last processed at: 08/08/2023 18:40:37 (UTC+00:00)
...
* msEdge3PScrollStateResetFix
 * msEdgeAlwaysUpToDateEnabled
 * msEdgeChatEligibility
 * msEdgePasswordImproveNewPasswordAutocomplete
 * msEEUsePageUnderstandingForPageClassification
 * msHistoryExportUI
 * msNurturingFileSearchMSBBannerFeature
 * msSilentCleanupEnabled
 * msSmartScreenUseStaticLibrary
 * msWalletCheckoutAutoSkipCoupons
 * msWebAssistHistorySearchTopResultsTrigger
 * msWorkspacesGettingStartedButton
