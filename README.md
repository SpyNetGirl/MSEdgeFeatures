...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 124.0.2476.0

### Last processed at: 03/21/2024 16:03:25 (UTC+00:00)
...
* msEdgeAutoRestoreTabsWithoutPrompt
 * msedgecrH3
 * msHideSearchItemIfAppUnavailable
 * msNurturingReclaimDBForEdgeProtocol
 * msNurturingSetDBForEdgeProtocol
 * msOptOutReclaimDBForMicrosoftEdgeProtocol
 * msOptOutReclaimDBForMicrosoftEdgeProtocolController
 * MSPCManaH1
 * msTriggeringUseYahooTestConfig
 * msWebView2EnableRendererAppContainer
