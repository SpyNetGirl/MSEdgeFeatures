...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 124.0.2474.0

### Last processed at: 03/20/2024 16:03:10 (UTC+00:00)
...
* msAccountTransferExp1
 * msAccountTransferExp2
 * msAccountTransferExp3
 * msEdgeAppTransformToBrowser
 * msEdgeSsGroupSuggestionMaxCoverage
 * msEdgeSuperDragRetentionMetric
 * msEdgeWebstoreZeroSearchResultsTrigger
 * msEnableMultiMonitorScreenLookupOptimization
 * msFavoritesBackfillFaviconTrigger
 * msNurturingFeaturePinToTaskbarDynamicImages
 * msNurturingServerDrivenVersioningLogic
 * msNurturingTestCampaign21Feature
 * mspdfA
 * msRobin
 * msShortcutConflict
