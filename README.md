...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 125.0.2500.0

### Last processed at: 04/02/2024 16:03:27 (UTC+00:00)
...
* msBrowserOpenForLongDurationTrigger
 * msChromePb70NtpFeedVisible
 * msChromePb70NtpOrPostFreDhpNavigation
 * msChromePb80NtpFeedVisible
 * msChromePb80NtpOrPostFreDhpNavigation
 * msChromePb90NtpFeedVisible
 * msChromePb90NtpOrPostFreDhpNavigation
 * msEdgeResourceControlsMainToggleNewBadge
 * msEdgeShoppingAutoApplyFetchOffers
 * msEdgeShoppingCohortsReclaimed
 * msEdgeShoppingCohortsVulnerable
 * msEdgeShoppingLogDebugInPane
