...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 147.0.3858.0
### Last processed at: 02/13/2026 16:52:08 (UTC+00:00)
<details>
...
* MsWShG
* msBingSearchStartedFromAddressBar
* msBingSearchStartedFromBingRequery
* msBingSearchStartedFromContextMenu
* msBingSearchStartedFromNewTabPageSearchBox
* msBingSearchStartedFromRenavigation
* msBingSearchStartedFromWindowsSearch
* msBingSerpNavigationStarted
* msEdgeNativeVideoScrubbing
* msEdgeSpaceworksPinning
* msEdgeToolsSkipFRE
* msEdgeToolsUseMouseWheelForScroll
* msOmniboxRelatedSearchesOnZeroInputSerp
* msSettingsCppDeprecated
* msSkipUnloadedTabAsActive
</details>
