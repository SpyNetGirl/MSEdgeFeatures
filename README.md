...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 120.0.2183.0

### Last processed at: 10/26/2023 00:06:31 (UTC+00:00)
...
* MSADegra
 * MSAUserFL
 * msAvatarButtonUIRErrorLabel2
 * msAvatarButtonUIRErrorLabel3
 * msAvatarButtonUIRErrorLabel4
 * msCardRoamingRetrySaveCard
 * msCryptoWalletPublicKeyAccountDerive
 * msDiscardExpiredTabsActionThresholdSeconds
 * msDiscardExpiredTabsExtra2ThresholdSeconds
 * msDiscardExpiredTabsExtraThresholdSeconds
 * msDiscardExpiredTabsExtraTrigger2
 * msEdgeAutofillProfileSuggestionAllowed
 * msEdgeAutofillRemoveFilledValueFromPopupUI
 * msEdgeShoppingAutoShowBackgroundAutoApply
 * msGamingRewardsHvaPitchBrowserUsageFetchDurationInDays
 * msGamingRewardsHvaPitchFreshnessInMinutes
 * msGamingRewardsHvaPitchGamingNumberOfDays
 * msGamingRewardsHvaPitchMinChromeUsagePercentage
 * msGamingRewardsHvaPitchMinDaysSinceFre
 * msGamingRewardsHvaPitchMinLoLNetworkUsageBytes
 * msGamingRewardsHvaPitchMinMinecraftNetworkUsageBytes
 * msGamingRewardsHvaPitchMinRobloxNetworkUsageBytes
 * msGamingRewardsHvaPitchModelVersion
 * msNurturingMSStartYJCompete
 * msNurturingMSStartYJCompeteTextPersonalized
 * msNurturingMSStartYJCompeteTextVolumn
 * msOmniboxPedalCopilotBingChat
 * msPerformActionActivateCI
 * msPrimaryOSAccountInfoCache
 * msSegmentationPlatformGamingRewardsHvaPitch
 * msSegmentationPlatformPathExistenceOverrideForTesting
 * msSettingsThemesColorPicker
 * msWalletCheckoutDAFOptimzer
 * msWalletCheckoutScriptAutofill
 * msWalletPasswordManagerNewEntry
