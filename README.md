...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 144.0.3715.0
### Last processed at: 12/03/2025 16:32:59 (UTC+00:00)
<details>
<summary>19 new features were added in the latest Edge Canary update</summary>

<br>

* msComposerChatSuggestions
* msEdgeJourneysDisableSummaryCooldown
* msSegmentationPlatformWhatsNewPageEligibilityOverrideForTesting
* msSegmentationPlatformWhatsNewPageReminderFeature
* msSegmentationPlatformWhatsNewPageReminderLaunchNotification
* msWhatsNewPageReminderAllowedLocales
* msWhatsNewPageReminderAnyBadgeShownDurationInDays
* msWhatsNewPageReminderBrowserUsageFetchDurationInDays
* msWhatsNewPageReminderBrowserVersionToCheck
* msWhatsNewPageReminderCheckByAlreadySeen
* msWhatsNewPageReminderControlVersion
* msWhatsNewPageReminderExecutionCadenceSeconds
* msWhatsNewPageReminderFreshnessInMinutes
* msWhatsNewPageReminderInitialExecutionDelaySeconds
* msWhatsNewPageReminderMinChromeUsageMB
* msWhatsNewPageReminderMinChromeUsagePercentage
* msWhatsNewPageReminderMinDaysSinceFre
* msWhatsNewPageReminderModelVersion
* msWhatsNewPageReminderNotificationExpireDurationInDays
</details>
