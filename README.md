...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 131.0.2901.0

### Last processed at: 10/17/2024 16:25:24 (UTC+00:00)
...
* msWalleCardMetadata
 * msEdgeShoppingProductTracking
 * msEdgeShoppingProductTrackingHideOurText
 * msEdgeShoppingProductTrackingHideShoppingTextOnVisibility
 * msEdgeShoppingProductTrackingHideShoppingIconOnVisibility
 * msEdgeShoppingProductTrackingActionOpenShoreline
 * msEdgeShoppingProductTrackingActionTrack
 * msNtpLayouts
 * msEdgeAADChatHoverPinV2
 * msEdgeMSAChatHoverPinV2
 * msVerticalTabsAllowedPrefsCachedEnabled
 * msNtpWidgetsPrefChanged
 * msArbitrationServiceReady
