...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 132.0.2911.0

### Last processed at: 10/22/2024 16:24:41 (UTC+00:00)
...
* msSegmentationPlatformSegmentResultOverrideForTesting
 * msSettingsDebugMode
 * msEdgeAutofillInternalsImprovements
 * msBingFeatures
 * msEdgeIncludeThemesDataInFeedback
 * msPreReadFilePolicy
 * msPressurePreReadFileTrigger
 * msRAMPreReadFileTrigger
 * msSSDPreReadFileTrigger
