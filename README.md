...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 144.0.3664.0
### Last processed at: 11/08/2025 01:29:01 (UTC+00:00)
<details>
<summary>15 new features were added in the latest Edge Canary update</summary>

<br>

* msBrowserLaunchEqualTrigger
* msBrowserLaunchWWETrigger
* msBrowserLaunchWWUTrigger
* msCloudPolicyV2Tasks
* msCopilotMigrateXamlPref
* msEdgeAtlasDownloadBingReferrerHideIntercept
* msEdgeAtlasDownloadIntercept
* msEdgeAtlasDownloadInterceptTreatmentParam
* msEdgePermissionPromptInTopChrome
* msEnableExtensionServiceWorkerGetVote
* msNurturingRecommendedSettingsGuidedDialog
* msPasswordBreachScanThrottleDisabled
* msSecureIPAllUsers
* msTextPredictionThreshold
