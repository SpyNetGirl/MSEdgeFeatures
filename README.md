...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 139.0.3385.0

### Last processed at: 06/16/2025 16:28:45 (UTC+00:00)
...
* msEdgeMetaOSCancelDeferredNavigation
 * msOneSessionPostSkippedFRE
 * msTwoSessionPostSkippedFRE
 * msThreeSessionPostSkippedFRE
 * msFourSessionPostSkippedFRE
 * msOnePlusSessionPostSkippedFRE
 * msTwoPlusSessionPostSkippedFRE
 * msThreePlusSessionPostSkippedFRE
 * msFourPlusSessionPostSkippedFRE
 * msChromePBAutoLaunchSession
 * msChromePBNonAutoLaunchSession
 * msNewFRESkippedAutolaunchSession
 * msNewFRESkippedNonAutolaunchSession
 * msChromePBAndNewFRESkippedAutolaunchSession
 * msChromePBAndNewFRESkippedNonAutolaunchSession
 * msFastFollowSCFRENotEligibleAutolaunchSession
 * msFastFollowSCFRENotEligibleNonAutolaunchSession
 * msChromePBAndNewFREAndFFSCFRESkippedAutolaunchSession
 * msChromePBAndNewFREAndFFSCFRESkippedNonAutolaunchSession
 * msNonCIConsentedAutolaunchSession
 * msNonCIConsentedNonAutolaunchSession
 * msSkippedFREConditionsMetAutolaunchSession
 * msSkippedFREConditionsMetNonAutolaunchSession
 * msTriggerSkippedNewFREAndNonCIConsentedUsers
 * msTriggerSkippedNewFRETargeted
 * msEnableRustyMIPForPDF
 * msEnableRustyMIPForProtectionHandler
