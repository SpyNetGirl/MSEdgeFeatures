...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 121.0.2226.0

### Last processed at: 11/16/2023 16:03:35 (UTC+00:00)
...
* msAbydosCustomTapDetection
 * msDesktopModeRunning
 * msEACSendActiveState
 * msEdgeChatPDFAutoShowTrigger
 * msEdgeNewTabDropDownTopSitesSection
 * msEnableRendererPackageCapability
 * msGamingRewardsHvaPitchAnyBadgeShownDurationInDays
 * msGamingRewardsHvaPitchExecutionCadenceSeconds
 * msGamingRewardsHvaPitchInitialExecutionDelaySeconds
 * msPDFIncrementalSave
 * msSegmentationPlatformGamingRewardsHvaPitchLaunchNotification
 * mSTJE1
