...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 145.0.3725.0
### Last processed at: 12/08/2025 16:31:19 (UTC+00:00)
<details>
...
* MsOuDH
* msEdgeVisionInCMC
* msMlEligibleAllConditionsMet
* msMlEligibleUserIgnoredCampaign
* msMlSuggestedTabsShown
* msPdfFormsRegenerateAP
* msPersonalizedLaunchIncreasedReach
* msPersonalizedLaunchSendSubdomains
* msSanConsumerNewTab
* msSanConsumerNewTabAsterPB
* msSanConsumerNewTabAsterPBLastAsterSession
* msSanConsumerNewTabAsterPBNoImport
* msSegmentationPlatformUrlInterestsJustInTimePdfLaunch
* msUpdatedPermissionsUI
* msWebUICopilotNotificationFlyoutInternals
</details>
