...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 128.0.2648.0

### Last processed at: 06/13/2024 16:03:34 (UTC+00:00)
...
* msAllowPuffinDifferentialUpdate
 * msDynamicCSPCheckForExtensionAPIs
 * msDynamicCSPCheckForExtensionAPIsConfig
 * msEdgeComposeInlineRewriteContextMenuEntry
 * msEdgeComposeInlineRewriteKeyboardSelectionEntry
 * msEdgeComposeInlineRewriteMouseSelectionEntry
 * msEdgeHealthInternals
 * msEdgePasswordParsingImprovementsTrigger
 * msHandleCIActivatedOnRemote
 * msShorelineSearchRedirectNavigationToTab
