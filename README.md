...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 135.0.3152.0

### Last processed at: 02/21/2025 16:24:08 (UTC+00:00)
...
* msEmxMachineProfileManager
 * msEmxSecurityInsightProvider
 * msUACompatibilityVersionFix
 * msEdgeFaviconService
 * msSingleClickInstallThroughEasBingCards
 * msExtensionsGrowthInitiativeHoldout
 * msEdgeUpdatesMoreMenuPill
 * msInterceptSuspiciousFavorite
 * msCheckSuspiciousFavoriteWhenClick
 * msNurturingInterceptSuspFavorite
