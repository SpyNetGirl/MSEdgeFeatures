...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 148.0.3938.0
### Last processed at: 03/25/2026 17:05:15 (UTC+00:00)
<details>
<summary>24 new features were added in the latest Edge Canary update</summary>

<br>

* msBrowsingStreakReminderAllowedLocales
* msBrowsingStreakReminderAnyBadgeShownDurationInDays
* msBrowsingStreakReminderBadgeExpireDeadlineHour
* msBrowsingStreakReminderBrowserUsageFetchDurationInDays
* msBrowsingStreakReminderControlVersion
* msBrowsingStreakReminderEarliestHour
* msBrowsingStreakReminderExecutionCadenceSeconds
* msBrowsingStreakReminderFreshnessInMinutes
* msBrowsingStreakReminderInitialExecutionDelaySeconds
* msBrowsingStreakReminderLatestHour
* msBrowsingStreakReminderMaxEdgeUsagePercentage
* msBrowsingStreakReminderMinChromeUsageMB
* msBrowsingStreakReminderMinChromeUsagePercentage
* msBrowsingStreakReminderMinDaysSinceFre
* msBrowsingStreakReminderMinTotalBrowserUsageMB
* msBrowsingStreakReminderModelVersion
* msCopilotNTPUpsellCooldownOverride
* msDisableComposeSuggestionList
* msEdgeBrowserEnhancementsSettingsWCopilot
* msRewardsBrowsingStreakHVAWebUI
* msRewardsBrowsingStreakHVAWebUIForTesting
* msSegmentationPlatformBrowsingStreakReminderFeature
* msSegmentationPlatformBrowsingStreakReminderLaunchNotification
* msWChromiumMinCharsForUrlProviders
</details>
