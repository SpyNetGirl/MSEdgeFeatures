...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 128.0.2719.0

### Last processed at: 07/18/2024 01:11:55 (UTC+00:00)
...
* msEdgePasswordCrowdSourceGoogleVoteUploadFix
 * msEdgePasswordCrowdSourceNewPasswordUploadFix
 * msPdfParserDynamicMemoryAlloc2
 * msNDFREWithChromePreInstalled
 * msSanPersonalizationConsentInOOBE
 * msSanPersonalizationConsentInSCOOBE
 * msNurturingScopedTrigger
 * msNurturingFeatureNonMVUUserPolicyManagerTrigger
 * msNurturingFeatureEdgeBrowserUsageLessThanThresholdPolicyManagerTrigger
 * msNurturingFeatureChromeBrowserUsageGreaterThanThresholdPolicyManagerTrigger
 * msNurturingFeatureTotalBrowserUsageGreaterThanThresholdPolicyManagerTrigger
