...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 125.0.2521.0

### Last processed at: 04/13/2024 16:03:03 (UTC+00:00)
...
* mS2JE1
 * msDlpShowNewDialogsForPaste
 * msEdgeAutoOpenTeamsHubAppV2
 * msEdgeAutoOpenTeamsHubAppV2Trigger
 * msEdgeBarCNFRE
 * msEdgeSsDisableAutocompleteSupport
 * msNurturingDLPDialog
 * msNurturingWorkspaceFromCurrentWindowInMultiBrowserSessions
 * msWindowInMultiBrowserSessionsTrigger
