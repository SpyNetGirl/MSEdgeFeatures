...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 128.0.2703.0

### Last processed at: 07/10/2024 16:06:50 (UTC+00:00)
...
* msConsumerUXOptimizationIEModeAllowFixTrigger
 * msEdgeAutofillUseMlForAdvancedSuggestions
 * msedgecrI3
 * msEdgeMouseGestureCloudConfigViaOperationConfig
 * msEdgeTabActionsMenuAnchorOffset
 * msEmxSecurityInsight
 * msMonitorLocalBookmark
 * msNurturingEnableShoppingAssistanceCashback
 * msPinRecommendationsFlowExecutionTrigger
 * msSuppressSavePasswordFlyoutWithEmptyUserName
 * msWalletCheckoutTopIndexCardSelect
 * msWorkSharePointFilesDeduping
