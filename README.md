...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 133.0.2974.0

### Last processed at: 11/23/2024 16:22:21 (UTC+00:00)

<details>
<summary>20 new features were added in the latest Edge Canary update</summary>

<br>

* msProvenanceValidatorSecondScreenshotCaptureDelayMinMs
 * msProvenanceValidatorSecondScreenshotCaptureDelayMaxMs
 * msOverrideFeedEngagementExpirationDays
 * msFeedEngagedNtpOrPostFreDhpNavigation
 * msNotFeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb70FeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb80FeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb90FeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb70NotFeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb80NotFeedEngagedNtpOrPostFreDhpNavigation
 * msChromePb90NotFeedEngagedNtpOrPostFreDhpNavigation
 * msFeedEngagedNtpFeedVisible
 * msNotFeedEngagedNtpFeedVisible
 * msChromePb70FeedEngagedNtpFeedVisible
 * msChromePb80FeedEngagedNtpFeedVisible
 * msChromePb90FeedEngagedNtpFeedVisible
 * msChromePb70NotFeedEngagedNtpFeedVisible
 * msChromePb80NotFeedEngagedNtpFeedVisible
 * msChromePb90NotFeedEngagedNtpFeedVisible
 * msSyncResetNewNow
