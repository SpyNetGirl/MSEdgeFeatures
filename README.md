...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 126.0.2592.0

### Last processed at: 05/17/2024 16:03:35 (UTC+00:00)
...
* msCryptoWalletDrawerRefinement
 * msEdgeAutofillShowOTPSuggestion
 * msEdgeSavedTabGroup
 * msEdgeSettingsNavigation
 * msEdgeSettingsSystemNavigation
 * msEdgeSmartPrint
 * msEdgeSydneySiteInfo
 * msEdgeWorkAutocompletePeopleAndBookmarks
 * msKodiakCollapseTextInPill
 * msNurturingEnableShoppingAssistanceOptinGeneric
 * msOmniboxEdgeBingHistoryGradientSpyglassIcon
 * msOmniboxResultsGradientSpyglassIcon
