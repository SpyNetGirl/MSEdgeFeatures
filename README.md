...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 138.0.3308.0

### Last processed at: 05/09/2025 01:42:16 (UTC+00:00)
...
* msLlmConsumerDlpPurviewFetchAfterEmx
 * msLlmConsumerDlpPurviewPayloadMonitor
 * msBypassFalconServiceCheckForLightningScreen
 * msEdgeAsterInclinedUserOptimizedFlow
 * msOmniboxSummarizeNewsNotificationUseOGArticleTag
 * msFluidEagerLoadingExtraTelemetry
 * msEdgeSpaceworksTabs
 * msEdgeSpaceworkTabGroup
 * msRing1KeepKeyIconsInContextMenu
 * msRing1MiniMenuKeepIfUsedRecently
 * msDetect3pPatchKeyFunc
 * msEdgeNtpVNextFocusUnifiedComposer
 * msEdgeComposerShowThinkDeeperMode
 * msNtpOptOutUpsellEligible
 * msFindOnPageCommercialCopilotSuggestions
 * msTextPredictionGlobalLanguage
