...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 125.0.2528.0

### Last processed at: 04/17/2024 00:05:01 (UTC+00:00)
...
* msAutofillEdgeTablesRowsCount
 * msEdgeComposeInlineStartWriting
 * msEdgeLockSettingsInNonActivatedOS
 * msEdgeMusicMessengerV2Task50112347
 * msEnableKeepAliveForMetricsRotationWatchdog
 * msKeepAliveForMetricsRotationWatchdogTimeoutSeconds
 * msNurturingTokenGrantedToUIEngineOrFullFrameworkOnboardedCampaign
 * msNurturingUICreationStarted
 * msWalletDonationRichNpo
 * msWalletShippingOnlySupportedForHIM
