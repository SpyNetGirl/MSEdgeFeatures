...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 130.0.2803.0

### Last processed at: 08/28/2024 01:16:44 (UTC+00:00)
...
* msEdgeCustomPassphraseEnabled
 * msEdgeFreSitePinningWithDelay
 * msPerfReportingPageLoadContentScriptsNew
 * msEdgeAutofillIgnoreCrowdSourceBlockDecision
 * msEdgeAutofillAdvancedSuggestionsSecondChance
 * msArbitrationServiceNotificationsSuppressLists
 * msArbitrationServiceDoNotDisturbSuppressNotifications
 * msSyncedPasswordEncryptionTitle
 * msSyncedPasswordEncryptionMessage
 * msSyncedPasswordEncryptionMSAMessage
 * msSyncedPasswordEncryptionPassphraseMessage
 * msSyncedPasswordEncryptionPassphraseExtendedMessage
 * msPassphrasePlaceholder
 * msPassphraseConfirmPlaceholder
