...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 127.0.2602.0

### Last processed at: 05/22/2024 00:05:28 (UTC+00:00)
...
* MSAAUTHPI
 * msCryptoWalletTokenAutoScan
 * msEdgeAutoGroupingSuggestionsPrefetchVerticalModeTrigger
 * msedgecrI3
 * msEdgeFREClosesOnEscape
 * msEdgeTabActionsMenuWindowView
 * msEdgeWorkAutocompletePeopleAndBookmarks
 * msHubAppsOmniboxNotificationsHoverToShowSnooze
 * msHubAppsOmniboxNotificationsShown
 * msHubAppsOmniboxNotificationsShowSnooze
 * msNurturingGetTokenCallForAllCampaigns
 * msNurturingGetTokenCallForCEOnboardedCampaign
