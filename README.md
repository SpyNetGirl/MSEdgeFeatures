...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 155.0.4272.0
### Last processed at: 09/11/2026 19:02:36 (UTC+00:00)
<details>
<summary>16 new features were added in the latest Edge Canary update</summary>

<br>

* msAutopilotComputerUse
* msCopilotProtectedSession
* msD2MSettingsEntry
* msEdgeCopilotBridgeWorkerPriority
* msEdgeIntentsAddressBarChipAfterFlyout
* msEdgeIntentsCopilotFullPage
* msEdgeOmniboxPinToTaskbar
* msEdgeOptimizationGuideManifestBroker
* msEdgeProfileIDClearStaleMUIDOnInitialGeneration
* msEdgeSearchHistoryNavAwareAggressiveWindow
* msEdgeToolsSuppressStopActionOnTabClose
* msEmxAdaptiveRefreshInterval
* msNurturingSplitViewPinnable
* msNurturingSplitViewTabSwitchTutorial
* msNurturingUndefinedFeaure
* msSwapInOnResumeForAnyPriority
</details>
