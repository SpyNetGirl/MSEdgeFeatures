...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 136.0.3215.0

### Last processed at: 03/24/2025 16:27:14 (UTC+00:00)
...
* msShoppingExp67Success
 * msEdgeRemoveDuplicateTabGroup
 * msPersonalizedAutolaunch
 * msAutoLaunchSession
 * msAutoLaunchSessionForConsumerUser
 * msAutolaunchSessionImportedTabsDontExist
 * msAutolaunchSessionImportedTabsDontExistForChromePBUser
 * msAutolaunchSessionChromePBSANConsentedConsumerWithoutImportedTabs
 * msAutolaunchSessionChromePBSANConsentedConsumerWithStartupSetToNewTab
 * msEdgeWorkSearchBannerOrganizationBrandingIcon
 * msRing1CleanupMenuIcons2
