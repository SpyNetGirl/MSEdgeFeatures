...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 126.0.2566.0

### Last processed at: 05/05/2024 00:05:46 (UTC+00:00)
...
* msEdgeChatServiceReadyLimits
 * msEdgeTabCollapsedGroupSeparateContainer
 * msGeolocationAccessService
 * msGeolocationOSLocationPermissionFallback
 * msNurturingWorkspaceFromCurrentWindowOnTabAction
 * msQuickSearchCopilotMenuForPdf
 * msQuickSearchCopilotMenuForWeb
 * msRestrictPrepopulateUsernameInSavePopup
 * msWellKnownDomainsHuffmanTreeSearch
