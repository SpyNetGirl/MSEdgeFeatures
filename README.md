...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 123.0.2395.0

### Last processed at: 02/10/2024 00:05:29 (UTC+00:00)
...
* msEdgeAutofillGroupSuggestionTelemetry
 * msEdgeAutoOpenBrowserWidthThreshold
 * msEdgeCircleToCopilotInMouseGesture
 * msEdgeCircleToCopilotInMouseGestureDefaultEnabled
 * msEdgeCircleToCopilotInScreenshotWithRightMouse
 * msEdgeCircleToCopilotOutsideEdge
 * msEdgeHubAppReorder
 * msEdgeScreenshotAddBingSearchIcon
 * msEdgeScreenshotAddCopilotIcon
 * msEdgeScreenshotAddOcrIcon
 * msEdgeScreenshotAddVisualSearchIcon
 * msEdgeSyncHistoryDataTypeRuntimeOverride
 * msEdgeSyncOnCloudMessaging
 * msNurturingServerDrivenOnDemandUIMetadata
 * msNurturingWorkspaceFromCurrentWindowOnTabGroupCreated
 * msOmniboxBoostDirectNavSuggestions
 * msRendererRestrictCoreSharing
 * msUndersideSearchPerspSkipClearHistoryForTesting
 * msWalletCheckoutCommercePlatform
