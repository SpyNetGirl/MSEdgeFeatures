...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 129.0.2789.0

### Last processed at: 08/21/2024 16:22:48 (UTC+00:00)
...
* msShoppingSocialSharingUpdate
 * msDiscoverPdpTopPriority
 * msLimitPdpNotificationsOnLowStages
 * msShoppingNotificationsFrequencyPref
 * msEdgeShoppingPriceHistoryOnceDayDomainSession
 * msEdgeShoppingLocalhostOnCSP
 * msEdgeShoppingClosePaneOnExpressCheckoutAutoShow
 * msEdgeShoppingSanConsentOnDiscover
 * msEdgeShoppingRewardsGuidedSwitch
 * msUnsupportedLanguageUXFix
 * msFavBarVisualRefreshTrigger
 * msFavBarVisualRefresh
 * msEdgeSyncUpdateImplicitDialog
