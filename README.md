...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 129.0.2749.0

### Last processed at: 08/01/2024 01:19:24 (UTC+00:00)
...
* msSegmentationPlatformEdgeTFLiteValidation
 * msEdgeAutofillPasswordArbitration
 * msWalletTokenizationEnpOnboardingEnabled
 * msPdfSharedLibraryLowCores
 * msPdfSharedLibraryHighCores
 * msUseOsCryptAsyncForImportedDataDecryption
 * msProcessAPPBKey
 * msRegisterAppBoundProviderToOsCryptAsync
 * msIncludeMismatchedTargetInFeedback
