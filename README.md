...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 131.0.2887.0

### Last processed at: 10/10/2024 16:23:29 (UTC+00:00)

<details>
<summary>18 new features were added in the latest Edge Canary update</summary>

<br>

* msSidebarContextMenuQuitAppIfAppOpen
 * msSyncBrowserUsageSegment0NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment1NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment2NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment3NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment4NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment5NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment6NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment7NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment8NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment9NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment10NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment11NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment12NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment13NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment14NtpOrPostFreDhpNavigation
 * msSyncBrowserUsageSegment15NtpOrPostFreDhpNavigation
 * msVisualCompanionBackendOverride
