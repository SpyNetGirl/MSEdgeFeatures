...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 129.0.2764.0

### Last processed at: 08/08/2024 16:21:39 (UTC+00:00)
...
* msWebView2DisableNonRendererAppContainer
 * msEdgeWebAppInstallIconReducedVisibility
 * msCopilotAndSidebarContextMenuUpdate
 * msDisplayPWAManifestSourcedScreenshots
 * msPwaOnHoverAnimate
 * msEnablePackageCapability
 * msDisableAppContainerUponAccessDenied
 * msNurturingFeatureBingAddressBarEducation
 * msNurturingBingAddressBarEducationService
 * msRedirectOfflineErrorPage
