...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 123.0.2377.0

### Last processed at: 02/01/2024 00:06:03 (UTC+00:00)
...
* msEdgeCircleToSearchDefaultEnabled
 * msEdgeCircleToSearchSupported
 * msEdgeHubAppReorder
 * msEdgeScreenshotWithCoVision
 * msEdgeSDSMOptOutUXEnabled
 * msLlmConsumerDlp
 * msMigratePartnerCodeForAppDefaultsV2
 * msPdfReadAloudIconOnToolbar
 * msRewardsAllowMarketingPageOpenActionCenter
 * msRewardsForceMarketingPageOpenActionCenterForTesting
 * msWebAppsPrivateAPILoadUrlUntilIdleParams
