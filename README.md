...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 119.0.2123.0

### Last processed at: 09/26/2023 00:34:09 (UTC+00:00)
...
* msDMAControlledSSOAndTokenFetch
 * msEdge3PAutosuggestClickedTextLogging
 * msEdgeAutofillExtendedBlocklist
 * msEdgeSoftFREThemesUnificationOfInboxColors
 * msEdgeStartupBoostEcoMode
 * msEmulateWindowsDesktopSku
 * msEmulateWindowsServerSku
 * msFavoritesV2ImageAndVideoDebugMode
 * msPdfThumbnailWatsonDiagnosis
 * msRenderViewMenuShowMoreSubmenu
