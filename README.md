...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 149.0.4015.0
### Last processed at: 05/04/2026 17:43:21 (UTC+00:00)
<details>
<summary>11 new features were added in the latest Edge Canary update</summary>

<br>

* msEdgeToolsScreenshotSensitiveRedaction
* msFamilySafetyInternalsBtr
* msIntentionallyBreakAuthForTesting
* msInteractiveReadAloudInOngoingVisionSession
* msInteractiveReadAloudInOngoingVisionSessionCEP
* msNtpExpUCRoutingControl
* msNtpExpUCRoutingTreatment
* msNtpUCRoutingOnMsnNtp
* msNurturingMSStartYJCompeteTextVolumn
* msPdfUndoRedo
* msToolbarDeclutterIncludeFavorites
</details>
