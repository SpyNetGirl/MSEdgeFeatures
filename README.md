...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 146.0.3829.0
### Last processed at: 01/29/2026 02:10:10 (UTC+00:00)
<details>
<summary>16 new features were added in the latest Edge Canary update</summary>

<br>

* msBrowserImageThemeTrigger
* msBrowserLaunchFrequentSitesUpsellTrigger
* msEdgeMediaControlsPlayMedia
* msEdgeStudioNTPJourneysTipsCombined
* msFeedVisibleAndNeverChangedFeedTrigger
* msFeedVisibleTrigger
...
* msGamingProcessUserTypeMinLoLNetworkUsageBytes
* msGamingProcessUserTypeMinOverwatchNetworkUsageBytes
* msGamingProcessUserTypeMinRobloxNetworkUsageBytes
* msGamingProcessUserTypeModelVersion
* msRewardsPinningPrePinSiteCountCheck
* msSegmentationPlatformGamingProcessUserTypeFeature
</details>
