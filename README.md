...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 119.0.2129.0

### Last processed at: 09/29/2023 00:33:36 (UTC+00:00)
...
* msAbydosACP
 * msCastingDiscoveryNetworkListWinrt
 * msEdgeAutofillLevoSkipOverlappingProfileSuggestions
 * msEdgeDevicePostureRecognition
 * msFindOnPageExperimentVersion
 * msFREThemesTrigger
 * msGlobalMediaControlsTrigger
 * msNurturingReauthNotification
 * msNurturingRecommendedSettingsCenterSettingsWindow
 * msNurturingResponsiveUI
 * msNurturingUseForegroundThread
 * msProfileFlyoutAccountErrorMessageA
 * msProfileFlyoutAccountErrorMessageB
 * msProfileFlyoutAccountErrorMessageC
 * msTokenizationCardRoamingEnrollmentHBIScope
 * msWorkspaces
 * msWorldcupCardShownOnNTP
