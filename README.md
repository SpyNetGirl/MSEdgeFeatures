...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 124.0.2449.0

### Last processed at: 03/08/2024 00:05:35 (UTC+00:00)
...
* msArbitrationServiceExperienceDataReset
 * msDevicePerformanceProfiles
 * msDownloadsWebComponentsUI
 * msEdgeBingChatSummarizationNotification
 * msEdgeEtreeEntranceClicked
 * msEdgeEtreeVisitWallet
 * msEdgeSCFRETriggerwithDMA24Hrs
 * msEdgeTranslateOnNtp
 * msEnableEdgeWebstoreHeaderWithSearch
 * msLocalhostRedirectSuspiciousUrlDetection
 * msLocalhostRedirectSuspiciousUrlMitigation
 * msNurturingFrameworkImportExtraDiagnostic
 * msPdfCrashKeyDiagnosticUserActions
 * msPdfTileCacheNoProgressiveRendering
 * msSidePanePopoverCloseBubble
 * msWalletPaymentMethodDeleteCardOptimize
