...
### <a href="https://github.com/HotCakeX/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 122.0.2359.0

### Last processed at: 01/23/2024 16:03:38 (UTC+00:00)
...
* msEdgeChurnBrowserNotOpenDays
 * msEdgeHubAppAdd2Bottom
 * msEdgePwaSidebarOpenedTrigger
 * msEdgeWebCaptureRationalizationHoldout
 * msGenericIconSidebarButtonHover
 * msNurturingBingGrowthToastNotification
 * msNurturingBingGrowthToastNotificationTextOnly
 * msNurturingOnboardNTPToCE
 * msNurturingShoppingNotificationArbitrationRequested
 * msNurturingShoppingNotificationRenderRequested
 * msTranslateVideo
 * msUseAddApp2BottomPrefsKey
 * msUserDataDirUsageTelemetry
 * msWalletCheckoutDAFPrescreen
