...
### <a href="https://github.com/SpyNetGirl/MSEdgeFeatures"><img width="35" src="https://github.com/HotCakeX/Harden-Windows-Security/raw/main/images/WebP/Edge%20Canary.webp"></a> Latest Edge Canary version: 143.0.3601.0
### Last processed at: 10/06/2025 16:26:50 (UTC+00:00)
<details>
<summary>15 new features were added in the latest Edge Canary update</summary>

<br>

* msClassifyComposerActionChat
* msCloudProfileReporting
...
* msEdgeToolsScreenshotEncoding
* msEdgeToolsScreenshotHeight
* msEdgeToolsScreenshotMaxPayloadSize
* msEdgeToolsScreenshotWidth
* msInitSendLockedStateNotify
* msSegmentationPlatformUrlInterestsInterceptOptimizationFeature
* msSummarizeWithCopilotNewBadge
* msTokenizationAutofillInlineEnabled
* msWorkspaceMigrationTrigger
</details>
