...
<details>
<summary>46 new features were added in the latest Edge Canary update</summary>

<br>

* msWalletHubAadUsers
 * msNtpStartNavigation
 * msDhpStartNavigation
 * msNtpOrDhpStartNavigation
 * msInPrivateNtpStartNavigation
 * msInPrivateDhpStartNavigation
 * msInPrivateNtpOrDhpStartNavigation
 * msGuestNtpStartNavigation
 * msGuestDhpStartNavigation
 * msGuestNtpOrDhpStartNavigation
 * msLocalNtpStartNavigation
 * msLocalDhpStartNavigation
 * msLocalNtpOrDhpStartNavigation
 * msOnlineNtpStartNavigation
 * msOnlineDhpStartNavigation
 * msOnlineNtpOrDhpStartNavigation
 * msRemoteNtpStartNavigation
 * msRemoteDhpStartNavigation
 * msRemoteNtpOrDhpStartNavigation
 * msPrerenderNtpStartNavigation
 * msPrerenderDhpStartNavigation
 * msPrerenderNtpOrDhpStartNavigation
 * msNonPrerenderNtpStartNavigation
 * msNonPrerenderDhpStartNavigation
 * msNonPrerenderNtpOrDhpStartNavigation
 * msLocalPrerenderNtpStartNavigation
 * msLocalPrerenderDhpStartNavigation
 * msLocalPrerenderNtpOrDhpStartNavigation
 * msLocalNonPrerenderNtpStartNavigation
 * msLocalNonPrerenderDhpStartNavigation
 * msLocalNonPrerenderNtpOrDhpStartNavigation
 * msOnlinePrerenderNtpStartNavigation
 * msOnlinePrerenderDhpStartNavigation
 * msOnlinePrerenderNtpOrDhpStartNavigation
 * msOnlineNonPrerenderNtpStartNavigation
 * msOnlineNonPrerenderDhpStartNavigation
 * msOnlineNonPrerenderNtpOrDhpStartNavigation
 * msRemotePrerenderNtpStartNavigation
 * msRemotePrerenderDhpStartNavigation
 * msRemotePrerenderNtpOrDhpStartNavigation
 * msRemoteNonPrerenderNtpStartNavigation
 * msRemoteNonPrerenderDhpStartNavigation
 * msRemoteNonPrerenderNtpOrDhpStartNavigation
 * msNotificationDefaultBrowserCampaignMLSuppression
 * msCopilotWindowExclusiveMinProcessors
 * msCopilotWindowExclusiveMinRamMB
